CLASS zcl_xslx2_autofilter DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ts_filter,
        ...
        t_values         TYPE HASHED TABLE OF zxslx2_cell_value WITH UNIQUE KEY table_line,
    ...
    DATA filter_area TYPE zxslx2_s_autofilter_area .
    ...
    METHODS get_filter_area
      RETURNING
        VALUE(rs_area) TYPE zxslx2_s_autofilter_area
      RAISING
        zcx_xslx2 .
    METHODS get_filter_range
      RETURNING
        VALUE(r_range) TYPE zxslx2_cell_value
      RAISING
        zcx_xslx2.
    METHODS get_filter_reference
      RETURNING
        VALUE(r_ref) TYPE zxslx2_range_value
      RAISING
        zcx_xslx2 .
    METHODS get_values
      RETURNING
        VALUE(rt_filter) TYPE zxslx2_t_autofilter_values .
    METHODS is_row_hidden
      IMPORTING
        !iv_row             TYPE zxslx2_cell_row
      RETURNING
        VALUE(rv_is_hidden) TYPE abap_bool .
    METHODS set_filter_area
      IMPORTING
        !is_area TYPE zxslx2_s_autofilter_area .
    METHODS set_text_filter
      IMPORTING
        !i_column            TYPE zxslx2_cell_column
    ...
    METHODS set_value
      IMPORTING
        !i_column TYPE zxslx2_cell_column
        !i_value  TYPE zxslx2_cell_value .
    METHODS set_values
      IMPORTING
        !it_values TYPE zxslx2_t_autofilter_values .
...
*"* do not include other source files here!!!
  PROTECTED SECTION.
    ...
    METHODS is_row_hidden_single_values
      IMPORTING
        !iv_row             TYPE zxslx2_cell_row
        !iv_col             TYPE zxslx2_cell_column
...
*"* do not include other source files here!!!
  PRIVATE SECTION.
    ...
    DATA worksheet TYPE REF TO zcl_xslx2_worksheet .
...
CLASS zcl_xslx2_autofilter IMPLEMENTATION.
  ...
  METHOD get_filter_range.
    ...
    l_col_start_c = zcl_xslx2_common=>convert_column2alpha( ip_column = filter_area-col_start ) .
    l_col_end_c   = zcl_xslx2_common=>convert_column2alpha( ip_column = filter_area-col_end ) .
  ...
  METHOD get_filter_reference.
    ...
    r_ref = zcl_xslx2_common=>escape_string( ip_value = l_value ).
...
*  see method documentation how to use this
  ...
  METHOD validate_area.
    DATA: l_col                   TYPE zxslx2_cell_column,
          ls_original_filter_area TYPE zxslx2_s_autofilter_area,
          l_row                   TYPE zxslx2_cell_row.
