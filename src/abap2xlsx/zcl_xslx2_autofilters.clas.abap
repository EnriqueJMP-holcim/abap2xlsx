CLASS zcl_xslx2_autofilters DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF ts_autofilter,
        ...
        autofilter TYPE REF TO zcl_xslx2_autofilter,
...
CLASS zcl_xslx2_autofilters IMPLEMENTATION.
  ...
  METHOD add.
    ...
    IF sy-subrc = 0.
      RAISE EXCEPTION TYPE zcx_xslx2. " adding another autofilter to sheet is not allowed
    ENDIF.
