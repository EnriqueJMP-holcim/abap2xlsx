CLASS zcl_xslx2_column DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        !ip_index     TYPE zxslx2_cell_column_alpha
    ...
    METHODS set_auto_size
      ...
      RETURNING
        VALUE(io_column) TYPE REF TO zcl_xslx2_column .
    ...
    METHODS set_column_style_by_guid
      IMPORTING
        !ip_style_guid TYPE zxslx2_cell_style
      RAISING
        zcx_xslx2 .
    METHODS get_column_style_guid
      RETURNING
        VALUE(ep_style_guid) TYPE zxslx2_cell_style
      RAISING
        zcx_xslx2 .
...
CLASS zcl_xslx2_column IMPLEMENTATION.


  METHOD constructor.
    me->column_index = zcl_xslx2_common=>convert_column2int( ip_index ).
    me->width         = -1.
  ...
  METHOD get_column_style_guid.
    ...
    ELSE.
      ep_style_guid = me->worksheet->zif_xslx2_sheet_properties~get_style( ).
    ENDIF.
  ENDMETHOD.
  ...
  METHOD set_column_style_by_guid.
    ...
    IF me->excel IS NOT BOUND.
      zcx_xslx2=>raise_text( 'Internal error - reference to ZCL_EXCEL not bound' ).
    ENDIF.
    TRY.
  ...
  METHOD set_width.
    TRY.
      ...
      CATCH cx_sy_conversion_no_number.
        zcx_xslx2=>raise_text( 'Unable to interpret width as number' ).
    ENDTRY.
  ENDMETHOD.
