CLASS zcl_xslx2_columns DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    METHODS add
      IMPORTING
        !io_column TYPE REF TO zcl_xslx2_column .
    METHODS clear .
    METHODS constructor .
    METHODS get
      IMPORTING
