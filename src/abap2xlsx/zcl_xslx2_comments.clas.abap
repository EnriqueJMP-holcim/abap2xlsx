CLASS zcl_xslx2_comments DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        !io_from TYPE REF TO zcl_xslx2_comments OPTIONAL .
    METHODS get
      IMPORTING
  ...
  PRIVATE SECTION.
    ...
    DATA comments TYPE REF TO zcl_xslx2_collection .
ENDCLASS.



CLASS zcl_xslx2_comments IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    DATA: lo_comment  TYPE REF TO zcl_xslx2_comment,
