...
CLASS zcl_xslx2_common DEFINITION LOCAL FRIENDS lcl_excel_common_test.
...
* ================
    TYPES: BEGIN OF ty_convert_range2column_a_row,
             column_start     TYPE zxslx2_cell_column_alpha,
             column_start_int TYPE zxslx2_cell_column,
             column_end       TYPE zxslx2_cell_column_alpha,
             column_end_int   TYPE zxslx2_cell_column,
             row_start        TYPE zxslx2_cell_row,
             row_end          TYPE zxslx2_cell_row,
             sheet            TYPE string,
           END OF ty_convert_range2column_a_row.
    DATA:
      lx_excel     TYPE REF TO zcx_xslx2,
      ls_symsg_act LIKE sy,                    " actual   messageinformation of exception
      ls_symsg_exp LIKE sy,                    " expected messageinformation of exception
      f_cut        TYPE REF TO zcl_xslx2_common.  "class under test
...
* ============================
    DATA ep_column TYPE zxslx2_cell_column_alpha.

* Test 1. Simple test
    TRY.
        ep_column = zcl_xslx2_common=>convert_column2alpha( 1 ).
...
* Test 2. Max column for OXML #16,384 = XFD
    TRY.
        ep_column = zcl_xslx2_common=>convert_column2alpha( 16384 ).
...
* Test 3. Index 0 is out of bounds
    TRY.
        ep_column = zcl_xslx2_common=>convert_column2alpha( 0 ).
...
* Test 4. Exception should be thrown index out of bounds
    TRY.
        ep_column = zcl_xslx2_common=>convert_column2alpha( 16385 ).
...
* ==========================
* Test 1. Basic test
    DATA ep_column TYPE zxslx2_cell_column.

    TRY.
        ep_column = zcl_xslx2_common=>convert_column2int( 'A' ).
  ...
  METHOD convert_column2int_from_int.
    ...
    ep_column = zcl_xslx2_common=>convert_column2int( 5 ).
...
* Test 2. Max column
    ...
    TRY.
        ep_column = zcl_xslx2_common=>convert_column2int( 'XFD' ).
...
* Test 3. Out of bounds
    ...
    TRY.
        ep_column = zcl_xslx2_common=>convert_column2int( '' ).
...
* Test 4. Out of bounds
    ...
    TRY.
        ep_column = zcl_xslx2_common=>convert_column2int( 'XFE' ).
  ...
  METHOD convert_column_a_row2columnrow.
    ...
    cell_coords = zcl_xslx2_common=>convert_column_a_row2columnrow( i_column = 'B' i_row = 6 ).

    cl_abap_unit_assert=>assert_equals( act = cell_coords exp = 'B6' ).


    cell_coords = zcl_xslx2_common=>convert_column_a_row2columnrow( i_column = 2 i_row = 6 ).
  ...
  METHOD convert_columnrow2column_a_row.
    ...
    DATA: column     TYPE zxslx2_cell_column_alpha,
          column_int TYPE zxslx2_cell_column,
  ...
  METHOD date_to_excel_string1.
    DATA ep_value TYPE zxslx2_cell_value.

* Test 1. Basic conversion
    ep_value = zcl_xslx2_common=>date_to_excel_string( '19000101' ).
...
* Check around the "Excel Leap Year" 1900
    ep_value = zcl_xslx2_common=>date_to_excel_string( '19000228' ).
  ...
  METHOD date_to_excel_string3.
    ...
    ep_value = zcl_xslx2_common=>date_to_excel_string( '19000301' ).
...
* Test 2. Basic conversion
    ep_value = zcl_xslx2_common=>date_to_excel_string( '99991212' ).
...
* Test 3. Initial date
    DATA: lv_date TYPE d.
    ep_value = zcl_xslx2_common=>date_to_excel_string( lv_date ).
...
* Test 2. Basic conversion
    DATA exp_value TYPE zxslx2_cell_value VALUE 0.
    ep_value = zcl_xslx2_common=>date_to_excel_string( '18991231' ).
  ...
  METHOD amount_to_excel_string1.
    ...
    ep_value = zcl_xslx2_common=>number_to_excel_string( ip_value    = '1003.99'
                                                         ip_currency = 'EUR' ).
  ...
  METHOD amount_to_excel_string3.
    ...
    ep_value = zcl_xslx2_common=>number_to_excel_string( ip_value    = '0'
                                                         ip_currency = 'HUF' ).
...
* ========================
    DATA lv_encrypted_pwd TYPE zxslx2_aes_password.

    TRY.
        lv_encrypted_pwd = zcl_xslx2_common=>encrypt_password( 'test' ).
...
* Test 1. Simple test -> ABAP Manage also date prior of 1900
    TRY.
        ep_value = zcl_xslx2_common=>excel_string_to_date( '0' ).
...
* Check empty content
    TRY.
        ep_value = zcl_xslx2_common=>excel_string_to_date( '' ).
...
* Check first Excel date 1/1/1900
    TRY.
        ep_value = zcl_xslx2_common=>excel_string_to_date( '1' ).
...
* Check around the "Excel Leap Year" 1900
    TRY.
        ep_value = zcl_xslx2_common=>excel_string_to_date( '59' ).
    ...
    ENDTRY.
    TRY.
        ep_value = zcl_xslx2_common=>excel_string_to_date( '61' ).
...
* Test 3. Last possible date
    TRY.
        ep_value = zcl_xslx2_common=>excel_string_to_date( '2958465' ).
...
* Test 4. Exception should be thrown index out of bounds
    TRY.
        ep_value = zcl_xslx2_common=>excel_string_to_date( '2958466' ).
...
* 45141.58832 (2023/08/03 14:07:11) ip_exact = abap_false -> 2023/08/04
    TRY.
        ep_value = zcl_xslx2_common=>excel_string_to_date( ip_value = '45141.58832'
                                                           ip_exact = abap_false ).
        cl_abap_unit_assert=>assert_equals(
          act   = ep_value
          exp   = '20230804' ).
...
* 45141.48832 (2023/08/03 11:43:11) ip_exact = abap_false -> 2023/08/03
    TRY.
        ep_value = zcl_xslx2_common=>excel_string_to_date( ip_value = '45141.48832'
                                                           ip_exact = abap_false ).
        cl_abap_unit_assert=>assert_equals(
          act   = ep_value
          exp   = '20230803' ).
...
* Test 1. Simple test
    ep_value = zcl_xslx2_common=>excel_string_to_time( '0' ).
...
* Test 2. Simple test
    ...
    ep_value = zcl_xslx2_common=>excel_string_to_time( '1' ).
...
* Test 3. Simple test
    ...
    ep_value = zcl_xslx2_common=>excel_string_to_time( '0.99999' ).
...
* Test 4. Also string greater than 1 should be managed
    ...
    ep_value = zcl_xslx2_common=>excel_string_to_time( '4.1' ).
...
* Test 4. string is not a number
    TRY.
        ep_value = zcl_xslx2_common=>excel_string_to_time( 'NaN' ).
...
* 45141.58832 (2023/08/03 14:07:11) -> 14:07:11
    TRY.
        ep_value = zcl_xslx2_common=>excel_string_to_time( ip_value = '45141.58832' ).
...
* Test 1. Basic conversion
    ep_value = zcl_xslx2_common=>time_to_excel_string( '000001' ).
...
* Test 2. Basic conversion
    ep_value = zcl_xslx2_common=>time_to_excel_string( '235959' ).
...
* Test 3. Initial date
    ep_value = zcl_xslx2_common=>time_to_excel_string( '000000' ).
...
* Test 2. Basic conversion
    ep_value = zcl_xslx2_common=>time_to_excel_string( '022400' ).
...
* Test 1. Basic conversion
    zcl_xslx2_common=>split_file( EXPORTING ip_file         = 'filename.xml'
...
* Test 2. no extension
    zcl_xslx2_common=>split_file( EXPORTING ip_file         = 'filename'
                                  IMPORTING ep_file         = ep_file
                                            ep_extension    = ep_extension
                                            ep_dotextension = ep_dotextension ).
...
***
  ...
  METHOD describe_structure.
    ...
    lt_structure = zcl_xslx2_common=>describe_structure( io_struct = lo_structdescr ).
  ...
  METHOD macro_calculate_cell_distance.
    ...
    zcl_xslx2_common=>calculate_cell_distance( EXPORTING iv_reference_cell = iv_reference_cell
...
* Check delta rows
  ...
  METHOD macro_shift_formula.
    ...
    TRY.
        lv_resulting_formula = zcl_xslx2_common=>shift_formula( iv_reference_formula = iv_reference_formula
...
* Test 1: upper left corner (in range)
    ...
    TRY.
        ep_cell_in_range = zcl_xslx2_common=>is_cell_in_range(
            ip_column   = 'B'
            ip_row      = 2
            ip_range    = 'B2:D4' ).
...
* Test 6: lower side (out of range)
  ...
  METHOD recursive_struct_to_class.
    ...
    DATA complete_style  TYPE zxslx2_s_cstyle_complete.
    DATA complete_stylex TYPE zxslx2_s_cstylex_complete.
    ...
    zcl_xslx2_common=>recursive_struct_to_class(
      EXPORTING
  ...
  METHOD escape_string_hyphen.
    ...
    escaped_name = zcl_xslx2_common=>escape_string( name ).
...
CLASS ltc_utclong_to_excel_string IMPLEMENTATION.
  METHOD simple.
    ...
    DATA lv_excel_string     TYPE zxslx2_cell_value.
    ...
    lv_excel_string = zcl_xslx2_common=>utclong_to_excel_string( <lv_utclong> ).
