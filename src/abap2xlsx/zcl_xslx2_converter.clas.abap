CLASS zcl_xslx2_converter DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    METHODS ask_option
      RETURNING
        VALUE(rs_option) TYPE zxslx2_s_converter_option
      RAISING
        zcx_xslx2 .
    METHODS convert
      IMPORTING
        !is_option     TYPE zxslx2_s_converter_option OPTIONAL
        ...
        !i_style_table TYPE zxslx2_table_style OPTIONAL
        !io_worksheet  TYPE REF TO zcl_xslx2_worksheet OPTIONAL
      CHANGING
        !co_excel      TYPE REF TO zcl_xslx2 OPTIONAL
      RAISING
        zcx_xslx2 .
    METHODS create_path
      RETURNING
...
*"* do not include other source files here!!!
  PROTECTED SECTION.
    ...
    DATA w_row_int TYPE zxslx2_cell_row VALUE 1. "#EC NOTEXT .  .  .  .  .  .  .  .  .  . " .
    DATA w_col_int TYPE zxslx2_cell_column VALUE 1. "#EC NOTEXT .  .  .  .  .  .  .  .  .  . " .
...
*"* do not include other source files here!!!
  PRIVATE SECTION.
    ...
    DATA wo_excel TYPE REF TO zcl_xslx2 .
    DATA wo_worksheet TYPE REF TO zcl_xslx2_worksheet .
    DATA wo_autofilter TYPE REF TO zcl_xslx2_autofilter .
    DATA wo_table TYPE REF TO data .
    DATA wo_data TYPE REF TO data .
    DATA wt_fieldcatalog TYPE zxslx2_t_converter_fcat .
    DATA ws_layout TYPE zxslx2_s_converter_layo .
    DATA wt_colors TYPE zxslx2_t_converter_col .
    DATA wt_filter TYPE zxslx2_t_converter_fil .
    ...
    CLASS-DATA ws_option TYPE zxslx2_s_converter_option .
    ...
    METHODS bind_table
      IMPORTING
        !i_style_table      TYPE zxslx2_table_style
      RETURNING
    ...
    METHODS create_color_style
      IMPORTING
        !i_style        TYPE zxslx2_cell_style
        !is_colors      TYPE zxslx2_s_converter_col
      RETURNING
        VALUE(ro_style) TYPE REF TO zcl_xslx2_style .
    METHODS create_formular_subtotal
      IMPORTING
        !i_row_int_start   TYPE zxslx2_cell_row
        !i_row_int_end     TYPE zxslx2_cell_row
        !i_column          TYPE zxslx2_cell_column_alpha
        !i_totals_function TYPE zxslx2_table_totals_function
      RETURNING
        VALUE(r_formula)   TYPE string .
    METHODS create_formular_total
      IMPORTING
        !i_row_int         TYPE zxslx2_cell_row
        !i_column          TYPE zxslx2_cell_column_alpha
        !i_totals_function TYPE zxslx2_table_totals_function
      RETURNING
        VALUE(r_formula)   TYPE string .
    METHODS create_style_hdr
      IMPORTING
        !i_alignment    TYPE zxslx2_alignment OPTIONAL
      RETURNING
        VALUE(ro_style) TYPE REF TO zcl_xslx2_style .
    ...
    METHODS get_color_style
      IMPORTING
        !i_row         TYPE zxslx2_cell_row
        !i_fieldname   TYPE fieldname
        !i_style       TYPE zxslx2_cell_style
      RETURNING
        VALUE(r_style) TYPE zxslx2_cell_style .
    ...
    METHODS get_style
      IMPORTING
        ...
        !i_alignment   TYPE zxslx2_alignment DEFAULT space
    ...
    METHODS loop_normal
      IMPORTING
        !i_row_int          TYPE zxslx2_cell_row
        !i_col_int          TYPE zxslx2_cell_column
      RETURNING
        VALUE(r_freeze_col) TYPE int1
      RAISING
        zcx_xslx2 .
    ...
    METHODS set_cell_format
      ...
      RETURNING
        VALUE(r_format) TYPE zxslx2_number_format .
    METHODS set_fieldcatalog .
ENDCLASS.



CLASS zcl_xslx2_converter IMPLEMENTATION.
...
* Do we need subtotals with grouping
  ...
  METHOD bind_table.
    DATA: lt_field_catalog TYPE zxslx2_t_fieldcatalog,
          ...
          ls_fcat          TYPE zxslx2_s_converter_fcat,
          lo_column        TYPE REF TO zcl_xslx2_column,
          lv_col_int       TYPE zxslx2_cell_column,
          lv_col_alpha     TYPE zxslx2_cell_column_alpha,
    ...
    ls_settings-top_left_column  = zcl_xslx2_common=>convert_column2alpha( ip_column = w_col_int ).
    ...
    ls_settings-bottom_right_column = zcl_xslx2_common=>convert_column2alpha( ip_column = lv_line ).
    ...
    LOOP AT wt_fieldcatalog INTO ls_fcat.
      ...
      lv_col_alpha = zcl_xslx2_common=>convert_column2alpha( lv_col_int ).
* Freeze panes
...
* Now let's check for visible
  ...
  METHOD class_constructor.
    ...
    DATA: ls_option TYPE zxslx2_s_converter_option,
  ...
  METHOD clean_fieldcatalog.
    ...
    FIELD-SYMBOLS: <fs_sfcat>   TYPE zxslx2_s_converter_fcat.
  ...
  METHOD convert.
    ...
    IF co_excel IS SUPPLIED.
      IF co_excel IS NOT BOUND.
        ...
        co_excel->zif_xslx2_book_properties~creator = sy-uname.
      ENDIF.
      wo_excel = co_excel.
    ENDIF.
...
* Move table to data object and clean it up
    ...
    IF wo_excel IS NOT BOUND.
      ...
      wo_excel->zif_xslx2_book_properties~creator = sy-uname.
    ENDIF.
  ...
  METHOD create_color_style.
    ...
    IF sy-subrc = 0.
      ...
      lo_style->fill->filltype       = zcl_xslx2_style_fill=>c_fill_solid.
...
*-obtain file separator character---------------------------------------
  ...
  METHOD create_style_hdr.
    ...
    lo_style->font->color-rgb      = zcl_xslx2_style_color=>c_white.
    lo_style->fill->filltype       = zcl_xslx2_style_fill=>c_fill_solid.
  ...
  METHOD create_style_normal.
    DATA: lo_style TYPE REF TO zcl_xslx2_style,
          l_format TYPE zxslx2_number_format.
  ...
  METHOD create_style_stripped.
    DATA:   lo_style    TYPE REF TO zcl_xslx2_style.
    DATA:  l_format    TYPE zxslx2_number_format.
  ...
  METHOD create_style_total.
    ...
    lo_style->borders->top->border_style       = zcl_xslx2_style_border=>c_border_thin.
    lo_style->borders->top->border_color-rgb   = zcl_xslx2_style_color=>c_black.

    CREATE OBJECT lo_style->borders->right.
    lo_style->borders->right->border_style       = zcl_xslx2_style_border=>c_border_none.
    lo_style->borders->right->border_color-rgb   = zcl_xslx2_style_color=>c_black.

    CREATE OBJECT lo_style->borders->down.
    lo_style->borders->down->border_style      = zcl_xslx2_style_border=>c_border_double.
    lo_style->borders->down->border_color-rgb  = zcl_xslx2_style_color=>c_black.

    CREATE OBJECT lo_style->borders->left.
    lo_style->borders->left->border_style       = zcl_xslx2_style_border=>c_border_none.
    lo_style->borders->left->border_color-rgb   = zcl_xslx2_style_color=>c_black.
  ...
  METHOD create_table.
    ...
    FIELD-SYMBOLS: <fs_scat>  TYPE zxslx2_s_converter_fcat,
                   <fs_stab>  TYPE any,
  ...
  METHOD create_text_subtotal.
    ...
    CASE i_totals_function.
      WHEN zcl_xslx2_table=>totals_function_sum.     " Total
        l_func = 'Total'(003).
      WHEN zcl_xslx2_table=>totals_function_min.     " Minimum
        l_func = 'Minimum'(004).
      WHEN zcl_xslx2_table=>totals_function_max.     " Maximum
        l_func = 'Maximum'(005).
      WHEN zcl_xslx2_table=>totals_function_average. " Mean Value
        l_func = 'Average'(006).
      WHEN zcl_xslx2_table=>totals_function_count.   " Count
        l_func = 'Count'(007).
      WHEN OTHERS.
        CLEAR l_func.
    ENDCASE.
  ...
  METHOD create_worksheet.
    ...
    IF wo_data IS BOUND AND wo_worksheet IS BOUND.
      ...
      wo_worksheet->zif_xslx2_sheet_properties~summarybelow = zif_xslx2_sheet_properties=>c_below_on. " By default is on
...
* Check for freeze panes
  ...
  METHOD execute_converter.
    DATA: lo_if               TYPE REF TO zif_xslx2_converter,
...
*  data lines of highest level.
  ...
  METHOD get_alv_converters.
    DATA:
      ...
      lr_implementation         TYPE REF TO zif_xslx2_converter,
  ...
  METHOD get_color_style.
    DATA: ls_colors       TYPE zxslx2_s_converter_col,
...
* Only field has color
  ...
  METHOD get_file.
    DATA: lo_excel_writer         TYPE REF TO zif_xslx2_writer.

    DATA: ls_seoclass TYPE seoclass.


    IF wo_excel IS BOUND.
      CREATE OBJECT lo_excel_writer TYPE zcl_xslx2_writer_2007.
...
*11  VARP
  ...
  METHOD loop_normal.
    DATA: l_row_int_end TYPE zxslx2_cell_row,
          l_row_int     TYPE zxslx2_cell_row,
          l_col_int     TYPE zxslx2_cell_column,
          l_col_alpha   TYPE zxslx2_cell_column_alpha,
          l_cell_value  TYPE zxslx2_cell_value,
          l_s_color     TYPE abap_bool,
          lo_column     TYPE REF TO zcl_xslx2_column,
          l_formula     TYPE zxslx2_cell_formula,
          l_style       TYPE zxslx2_cell_style,
          l_cells       TYPE i,
          l_count       TYPE i,
          l_table_row   TYPE i.
    ...
    FIELD-SYMBOLS: <fs_stab>   TYPE any,
                   ...
                   <fs_sfcat>  TYPE zxslx2_s_converter_fcat,
                   <fs_fldval> TYPE any.
...
*   Freeze panes
      ...
      l_col_alpha = zcl_xslx2_common=>convert_column2alpha( l_col_int ).
...
* Now let's check for total versus subtotal.
  ...
  METHOD loop_subtotal.
    ...
    DATA: l_row_int_start   TYPE zxslx2_cell_row,
          l_row_int_end     TYPE zxslx2_cell_row,
          l_row_int         TYPE zxslx2_cell_row,
          l_col_int         TYPE zxslx2_cell_column,
          l_col_alpha       TYPE zxslx2_cell_column_alpha,
          l_col_alpha_start TYPE zxslx2_cell_column_alpha,
          l_cell_value      TYPE zxslx2_cell_value,
          l_s_color         TYPE abap_bool,
          lo_column         TYPE REF TO zcl_xslx2_column,
          ...
          l_count           TYPE i,
          l_table_row       TYPE i,
          lt_fcat           TYPE zxslx2_t_converter_fcat.
...
*  lo_row_dim->set_collapsed( ip_collapsed =  <fs_sfcat>-is_collapsed ) . Not on grand total
    ...
    l_col_alpha_start = zcl_xslx2_common=>convert_column2alpha( i_col_int ).
...
* Now let's check for visible
  ...
  METHOD set_autofilter_area.
    DATA: ls_area   TYPE zxslx2_s_autofilter_area,
          l_lines   TYPE i,
...
* Let's check for filter.
  ...
  METHOD set_fieldcatalog.
    ...
    DATA: lr_data        TYPE REF TO data,
          ...
          ls_dfies       TYPE dfies.
    DATA: ls_fcat             TYPE zxslx2_s_converter_fcat.
