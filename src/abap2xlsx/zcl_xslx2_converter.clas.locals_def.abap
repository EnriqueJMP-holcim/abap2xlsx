...
TYPES: BEGIN OF ts_subtotal_rows,
         row_int       TYPE zxslx2_cell_row,
         row_int_start TYPE zxslx2_cell_row,
...
TYPES: BEGIN OF ts_styles,
         ...
         alignment TYPE zxslx2_alignment,
...
TYPES: BEGIN OF ts_color_styles,
         guid_old  TYPE zxslx2_cell_style,
         fontcolor TYPE zxslx2_style_color_argb,
         fillcolor TYPE zxslx2_style_color_argb,
         style_new TYPE REF TO zcl_xslx2_style,
