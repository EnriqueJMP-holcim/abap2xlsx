CLASS zcl_xslx2_converter_alv DEFINITION
  PUBLIC
  ABSTRACT
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    INTERFACES zif_xslx2_converter
...
*"* do not include other source files here!!!
  PROTECTED SECTION.
    ...
    DATA ws_option TYPE zxslx2_s_converter_option .

    METHODS update_catalog
      CHANGING
        !cs_layout       TYPE zxslx2_s_converter_layo
        !ct_fieldcatalog TYPE zxslx2_t_converter_fcat .
    METHODS apply_sort
      IMPORTING
...
CLASS zcl_xslx2_converter_alv IMPLEMENTATION.
...
* Red
  ...
  METHOD get_color.
    DATA: ls_con_col TYPE zxslx2_s_converter_col,
...
* Char 4 = Inverse display = 0 = of
  ...
  METHOD get_filter.
    DATA: ls_filt   TYPE lvc_s_filt,
          l_line    TYPE i,
          ls_filter TYPE zxslx2_s_converter_fil.
  ...
  METHOD update_catalog.
    DATA: ls_fieldcatalog TYPE zxslx2_s_converter_fcat,
...
* for now abap_true
        ...
        CASE ls_fcat-do_sum.
          WHEN abap_true.
            ls_fieldcatalog-totals_function =  zcl_xslx2_table=>totals_function_sum.
          WHEN 'A'.
            ls_fieldcatalog-totals_function =  zcl_xslx2_table=>totals_function_min.
          WHEN 'B' .
            ls_fieldcatalog-totals_function =  zcl_xslx2_table=>totals_function_max.
          WHEN 'C' .
            ls_fieldcatalog-totals_function =  zcl_xslx2_table=>totals_function_average.
          WHEN OTHERS.
...
* Alignment in each cell
        CASE ls_fcat-just.
          WHEN 'R'.
            ls_fieldcatalog-alignment = zcl_xslx2_style_alignment=>c_horizontal_right.
          WHEN 'L'.
            ls_fieldcatalog-alignment = zcl_xslx2_style_alignment=>c_horizontal_left.
          WHEN 'C'.
            ls_fieldcatalog-alignment = zcl_xslx2_style_alignment=>c_horizontal_center.
          WHEN OTHERS.
...
* Check for subtotals.
        ...
        IF sy-subrc = 0 AND  ws_option-subtot <> abap_false.
          ...
          IF ls_fieldcatalog-is_subtotalled = abap_true.
            ...
            ls_fieldcatalog-totals_function = zcl_xslx2_table=>totals_function_sum. " we need function for text
          ENDIF.
        ENDIF.
