CLASS zcl_xslx2_data_validations DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    METHODS add
      IMPORTING
        !ip_data_validation TYPE REF TO zcl_xslx2_data_validation .
    METHODS clear .
    METHODS constructor .
...
*"* do not include other source files here!!!
  PRIVATE SECTION.
    ...
    DATA data_validations TYPE REF TO zcl_xslx2_collection .
ENDCLASS.



CLASS zcl_xslx2_data_validations IMPLEMENTATION.
