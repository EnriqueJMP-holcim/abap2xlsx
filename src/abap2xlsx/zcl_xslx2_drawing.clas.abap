CLASS zcl_xslx2_drawing DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .

  PUBLIC SECTION.
    CONSTANTS c_graph_pie TYPE zxslx2_graph_type VALUE 1.   "#EC NOTEXT
    CONSTANTS c_graph_line TYPE zxslx2_graph_type VALUE 2.  "#EC NOTEXT
    CONSTANTS c_graph_bars TYPE zxslx2_graph_type VALUE 0.  "#EC NOTEXT
    DATA graph_type TYPE zxslx2_graph_type .
    DATA title TYPE string VALUE 'image1.jpg'.              "#EC NOTEXT
    CONSTANTS type_image TYPE zxslx2_drawing_type VALUE 'image'. "#EC NOTEXT
    CONSTANTS type_chart TYPE zxslx2_drawing_type VALUE 'chart'. "#EC NOTEXT
    CONSTANTS anchor_absolute TYPE zxslx2_drawing_anchor VALUE 'ABS'. "#EC NOTEXT
    CONSTANTS anchor_one_cell TYPE zxslx2_drawing_anchor VALUE 'ONE'. "#EC NOTEXT
    CONSTANTS anchor_two_cell TYPE zxslx2_drawing_anchor VALUE 'TWO'. "#EC NOTEXT
    DATA graph TYPE REF TO zcl_xslx2_graph .
    ...
    CONSTANTS type_image_header_footer TYPE zxslx2_drawing_type VALUE 'hd_ft'. "#EC NOTEXT
    ...
    METHODS get_from_col
      RETURNING
        VALUE(r_from_col) TYPE zxslx2_cell_column .
    METHODS get_from_row
      RETURNING
        VALUE(r_from_row) TYPE zxslx2_cell_row .
    METHODS get_guid
      RETURNING
        VALUE(ep_guid) TYPE zxslx2_guid .
    ...
    METHODS get_to_col
      RETURNING
        VALUE(r_to_col) TYPE zxslx2_cell_column .
    METHODS get_to_row
      RETURNING
        VALUE(r_to_row) TYPE zxslx2_cell_row .
    ...
    METHODS set_position
      IMPORTING
        !ip_from_row TYPE zxslx2_cell_row
        !ip_from_col TYPE zxslx2_cell_column_alpha
    ...
    METHODS set_position2
      IMPORTING
        !ip_from   TYPE zxslx2_drawing_location
        !ip_to     TYPE zxslx2_drawing_location
        !ip_anchor TYPE zxslx2_drawing_anchor OPTIONAL .
    METHODS get_position
      RETURNING
        VALUE(rp_position) TYPE zxslx2_drawing_position .
    METHODS get_type
      RETURNING
        VALUE(rp_type) TYPE zxslx2_drawing_type .
    METHODS get_index
      RETURNING
...
*"* do not include other source files here!!!
    DATA type TYPE zxslx2_drawing_type VALUE type_image. "#EC NOTEXT .  .  .  .  .  .  .  .  .  .  . " .
    DATA index TYPE string .
    DATA anchor TYPE zxslx2_drawing_anchor VALUE anchor_one_cell. "#EC NOTEXT .  .  .  .  .  .  .  .  .  .  . " .
    ...
    DATA from_loc TYPE zxslx2_drawing_location .
    DATA to_loc TYPE zxslx2_drawing_location .
    DATA size TYPE zxslx2_drawing_size .
...
CLASS zcl_xslx2_drawing IMPLEMENTATION.
...
* suppose 96 DPI
  ...
  METHOD load_chart_attributes.
    ...
    DATA lo_barchart TYPE REF TO zcl_xslx2_graph_bars.
    DATA lo_piechart TYPE REF TO zcl_xslx2_graph_pie.
    DATA lo_linechart TYPE REF TO zcl_xslx2_graph_line.
    ...
    zcl_xslx2_reader_2007=>fill_struct_from_attributes( EXPORTING ip_element = node2 CHANGING cp_structure = ls_prop ).
...
*           depth     = 0
        ...
        WHILE lo_node IS BOUND.
          ...
          zcl_xslx2_reader_2007=>fill_struct_from_attributes( EXPORTING ip_element = node3 CHANGING cp_structure = ls_prop ).
          lv_idx = ls_prop-val.
        ...
        WHILE lo_node IS BOUND.
          ...
          IF sy-index EQ 1. "catAx
            ...
            CALL METHOD lo_barchart->create_ax
              EXPORTING
                ip_axid          = lv_axid
                ip_type          = zcl_xslx2_graph_bars=>c_catax
          ...
          ELSEIF sy-index EQ 2. "valAx
            ...
            CALL METHOD lo_barchart->create_ax
              EXPORTING
                ip_axid          = lv_axid
                ip_type          = zcl_xslx2_graph_bars=>c_valax
                ip_orientation   = lv_orientation
                ip_delete        = lv_delete
                ip_axpos         = lv_axpos
                ip_formatcode    = lv_formatcode
...
*           depth     = 0
        ...
        WHILE lo_node IS BOUND.
          ...
          IF sy-index EQ 1. "catAx
            ...
            CALL METHOD lo_linechart->create_ax
              EXPORTING
                ip_axid          = lv_axid
                ip_type          = zcl_xslx2_graph_line=>c_catax
                ip_orientation   = lv_orientation
                ip_delete        = lv_delete
                ip_axpos         = lv_axpos
                ip_formatcode    = lv_formatcode
          ...
          ELSEIF sy-index EQ 2. "valAx
            ...
            CALL METHOD lo_linechart->create_ax
              EXPORTING
                ip_axid          = lv_axid
                ip_type          = zcl_xslx2_graph_line=>c_valax
                ip_orientation   = lv_orientation
                ip_delete        = lv_delete
                ip_axpos         = lv_axpos
                ip_formatcode    = lv_formatcode
    ...
    zcl_xslx2_reader_2007=>fill_struct_from_attributes( EXPORTING ip_element = node2 CHANGING cp_structure = ls_pagemargins ).
...
* suppose 96 DPI
  ...
  METHOD set_position.
    from_loc-col = zcl_xslx2_common=>convert_column2int( ip_from_col ) - 1.
  ...
  METHOD set_position2.
    ...
    DATA: lv_anchor                     TYPE zxslx2_drawing_anchor.
    lv_anchor = ip_anchor.
