CLASS zcl_xslx2_font DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS lc_default_font_name TYPE zxslx2_style_font_name VALUE 'Calibri' ##NO_TEXT.

    CLASS-METHODS calculate_text_width
      IMPORTING
        !iv_font_name   TYPE zxslx2_style_font_name
        !iv_font_height TYPE ty_font_height
        !iv_flag_bold   TYPE abap_bool
        !iv_flag_italic TYPE abap_bool
        !iv_cell_value  TYPE zxslx2_cell_value
      RETURNING
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF mty_s_font_cache,
        font_name       TYPE zxslx2_style_font_name,
...
CLASS zcl_xslx2_font IMPLEMENTATION.
