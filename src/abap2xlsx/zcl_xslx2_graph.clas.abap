CLASS zcl_xslx2_graph DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
    ...
    METHODS create_serie
      IMPORTING
        ...
        !ip_lbl_from_col     TYPE zxslx2_cell_column_alpha OPTIONAL
        !ip_lbl_from_row     TYPE zxslx2_cell_row OPTIONAL
        !ip_lbl_to_col       TYPE zxslx2_cell_column_alpha OPTIONAL
        !ip_lbl_to_row       TYPE zxslx2_cell_row OPTIONAL
        !ip_lbl              TYPE string OPTIONAL
        !ip_ref_from_col     TYPE zxslx2_cell_column_alpha OPTIONAL
        !ip_ref_from_row     TYPE zxslx2_cell_row OPTIONAL
        !ip_ref_to_col       TYPE zxslx2_cell_column_alpha OPTIONAL
        !ip_ref_to_row       TYPE zxslx2_cell_row OPTIONAL
        !ip_ref              TYPE string OPTIONAL
        !ip_sername          TYPE string
        !ip_sheet            TYPE zxslx2_sheet_title OPTIONAL .
    METHODS set_style
      IMPORTING
...
CLASS zcl_xslx2_graph IMPLEMENTATION.
  ...
  METHOD create_serie.
    ...
    IF ip_lbl IS NOT SUPPLIED.
      ...
      ls_serie-lbl = zcl_xslx2_common=>escape_string( ip_value = ls_serie-lbl ).
    ...
    IF ip_ref IS NOT SUPPLIED.
      ...
      ls_serie-ref = zcl_xslx2_common=>escape_string( ip_value = ls_serie-ref ).
