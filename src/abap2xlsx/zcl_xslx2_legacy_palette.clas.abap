CLASS zcl_xslx2_legacy_palette DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
    ...
    METHODS get_color
      IMPORTING
        !ip_index       TYPE i
      RETURNING
        VALUE(ep_color) TYPE zxslx2_style_color_argb
      RAISING
        zcx_xslx2 .
    METHODS get_colors
      RETURNING
        VALUE(ep_colors) TYPE zxslx2_t_style_color_argb .
    METHODS set_color
      IMPORTING
        !ip_index TYPE i
        !ip_color TYPE zxslx2_style_color_argb
      RAISING
        zcx_xslx2 .
  PROTECTED SECTION.
...
*"* do not include other source files here!!!
    ...
    DATA colors TYPE zxslx2_t_style_color_argb .
ENDCLASS.



CLASS zcl_xslx2_legacy_palette IMPLEMENTATION.
  ...
  METHOD get_color.
    ...
    IF sy-subrc <> 0.
      zcx_xslx2=>raise_text( 'Invalid color index' ).
    ENDIF.
  ENDMETHOD.
