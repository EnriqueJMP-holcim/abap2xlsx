CLASS zcl_xslx2_range DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    DATA name TYPE zxslx2_range_name .
    DATA guid TYPE zxslx2_range_guid .

    METHODS get_guid
      RETURNING
        VALUE(ep_guid) TYPE zxslx2_range_guid .
    METHODS set_value
      IMPORTING
    ...
    METHODS get_value
      RETURNING
        VALUE(ep_value) TYPE zxslx2_range_value .
    METHODS set_range_value
      IMPORTING
        !ip_value TYPE zxslx2_range_value .
...
*"* do not include other source files here!!!
  PRIVATE SECTION.
    ...
    DATA value TYPE zxslx2_range_value .
ENDCLASS.



CLASS zcl_xslx2_range IMPLEMENTATION.
  ...
  METHOD set_value.
    ...
    me->value = zcl_xslx2_common=>escape_string( ip_value = lv_value ).
