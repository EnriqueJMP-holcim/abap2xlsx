CLASS zcl_xslx2_reader_2007 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
      BEGIN OF t_relationship,
        ...
        worksheet    TYPE REF TO zcl_xslx2_worksheet,
    ...
    TYPES:
      ...
      END OF t_range .
    TYPES:
      t_fills   TYPE STANDARD TABLE OF REF TO zcl_xslx2_style_fill WITH NON-UNIQUE DEFAULT KEY .
    TYPES:
      t_borders TYPE STANDARD TABLE OF REF TO zcl_xslx2_style_borders WITH NON-UNIQUE DEFAULT KEY .
    TYPES:
      t_fonts   TYPE STANDARD TABLE OF REF TO zcl_xslx2_style_font WITH NON-UNIQUE DEFAULT KEY .
    TYPES:
      t_style_refs TYPE STANDARD TABLE OF REF TO zcl_xslx2_style WITH NON-UNIQUE DEFAULT KEY .
    TYPES:
      BEGIN OF t_color,
        indexed TYPE string,
        rgb     TYPE string,
    ...
    TYPES:
      BEGIN OF ty_ref_formulae,
        sheet   TYPE REF TO zcl_xslx2_worksheet,
        row     TYPE i,
        column  TYPE i,
        si      TYPE i,
        ref     TYPE string,
    ...
    DATA mt_dxf_styles TYPE zxslx2_t_styles_cond_mapping .

    METHODS fill_row_outlines
      IMPORTING
        !io_worksheet TYPE REF TO zcl_xslx2_worksheet
      RAISING
        zcx_xslx2 .
    ...
    METHODS load_style_font
      ...
      RETURNING
        VALUE(ro_font)  TYPE REF TO zcl_xslx2_style_font .
    ...
    METHODS load_style_num_formats
      IMPORTING
        !ip_xml               TYPE REF TO if_ixml_document
      RETURNING
        VALUE(ep_num_formats) TYPE zcl_xslx2_style_number_format=>t_num_formats .
    ...
    METHODS load_worksheet_cond_format_aa
      IMPORTING
        ...
        !io_style_cond TYPE REF TO zcl_xslx2_style_cond.
    ...
    METHODS get_dxf_style_guid
      IMPORTING
        ...
        !io_excel            TYPE REF TO zcl_xslx2
      RETURNING
        VALUE(rv_style_guid) TYPE zxslx2_cell_style .
    METHODS load_theme
      IMPORTING
        iv_path   TYPE string
        !ip_excel TYPE REF TO zcl_xslx2
...
CLASS zcl_xslx2_reader_2007 IMPLEMENTATION.
  ...
  METHOD fill_row_outlines.
    ...
    DATA: lt_row_data             TYPE ltt_row_data,
          ...
          lt_outline_rows         TYPE zcl_xslx2_worksheet=>mty_ts_outlines_row,
          ls_outline_row          LIKE LINE OF lt_outline_rows,
          lo_row                  TYPE REF TO zcl_xslx2_row,
          lo_row_iterator         TYPE REF TO zcl_xslx2_collection_iterator,
...
* we now need to determine whether the outline is collapsed or not
    LOOP AT lt_outline_rows INTO ls_outline_row.
      ...
      IF io_worksheet->zif_xslx2_sheet_properties~summarybelow = zif_xslx2_sheet_properties=>c_below_off.
...
*--------------------------------------------------------------------*
  ...
  METHOD get_dxf_style_guid.
    ...
    DATA: ls_cstyle  TYPE zxslx2_s_cstyle_complete,
          ls_cstylex TYPE zxslx2_s_cstylex_complete.
          ...
          IF lo_ixml_element IS BOUND.
            ...
            IF lo_ixml_element2 IS BOUND.
              ...
              IF lv_val IS NOT INITIAL.
                ls_cstyle-fill-filltype       = zcl_xslx2_style_fill=>c_fill_solid.
...
*   lo_istream        = lo_streamfactory->create_istream_xstring( lv_content ).
  ...
  METHOD load_drawing_anchor.
    ...
    DATA: lo_drawing     TYPE REF TO zcl_xslx2_drawing,
          ...
          ls_upper       TYPE zxslx2_drawing_location,
          ls_lower       TYPE zxslx2_drawing_location,
          ls_size        TYPE zxslx2_drawing_size,
          ext            TYPE t_ext,
          ...
          blip           TYPE t_blip,
          chart          TYPE t_chart,
          drawing_type   TYPE zxslx2_drawing_type,
    ...
    ELSE.
      ...
      TRY.
          ls_size-width  = zcl_xslx2_drawing=>emu2pixel( ls_size-width ).
        CATCH cx_root.
      ENDTRY.
      TRY.
          ls_size-height = zcl_xslx2_drawing=>emu2pixel( ls_size-height ).
        CATCH cx_root.
      ENDTRY.
    ENDIF.
    ...
    IF node IS NOT INITIAL.
      ...
      drawing_type = zcl_xslx2_drawing=>type_image.
    ENDIF.
    ...
    IF node IS NOT INITIAL.
      ...
      drawing_type = zcl_xslx2_drawing=>type_chart.
    ENDIF.
    ...
    IF drawing_type = zcl_xslx2_drawing=>type_chart.
...
*--------------------------------------------------------------------*
    ...
    DATA:
      ...
      lo_font               TYPE REF TO zcl_xslx2_style_font,
      ls_rtf                TYPE zxslx2_s_rtf,
...
*--------------------------------------------------------------------*
    ...
    DATA: lo_styles_xml                 TYPE REF TO if_ixml_document,
          lo_style                      TYPE REF TO zcl_xslx2_style,

          lt_num_formats                TYPE zcl_xslx2_style_number_format=>t_num_formats,
          lt_fills                      TYPE t_fills,
          lt_borders                    TYPE t_borders,
          lt_fonts                      TYPE t_fonts,

          ls_num_format                 TYPE zcl_xslx2_style_number_format=>t_num_format,
          ls_fill                       TYPE REF TO zcl_xslx2_style_fill,
          ls_cell_border                TYPE REF TO zcl_xslx2_style_borders,
          ls_font                       TYPE REF TO zcl_xslx2_style_font,
...
*--------------------------------------------------------------------*
        ...
        IF lo_node_cellxfs_xf_protection IS BOUND.
          ...
          IF ls_protection-locked = '1' OR ls_protection-locked = 'true'.
            lo_style->protection->locked = zcl_xslx2_style_protection=>c_protection_locked.
          ELSE.
            lo_style->protection->locked = zcl_xslx2_style_protection=>c_protection_unlocked.
          ENDIF.

          IF ls_protection-hidden = '1' OR ls_protection-hidden = 'true'.
            lo_style->protection->hidden = zcl_xslx2_style_protection=>c_protection_hidden.
          ELSE.
            lo_style->protection->hidden = zcl_xslx2_style_protection=>c_protection_unhidden.
          ENDIF.
...
*--------------------------------------------------------------------*
    DATA: lo_node_border      TYPE REF TO if_ixml_element,
          ...
          lo_cell_border      TYPE REF TO zcl_xslx2_style_borders,
          lo_border           TYPE REF TO zcl_xslx2_style_border,
...
*--------------------------------------------------------------------*
      IF lo_node_border->get_attribute( 'diagonalDown' ) IS NOT INITIAL.
        ADD zcl_xslx2_style_borders=>c_diagonal_down TO lo_cell_border->diagonal_mode.
      ENDIF.

      IF lo_node_border->get_attribute( 'diagonalUp' ) IS NOT INITIAL.
        ADD zcl_xslx2_style_borders=>c_diagonal_up TO lo_cell_border->diagonal_mode.
      ENDIF.
...
*--------------------------------------------------------------------*
    DATA: lv_value           TYPE string,
          ...
          lo_fill            TYPE REF TO zcl_xslx2_style_fill,
          ls_color           TYPE t_color.
...
* §1 built-in numberformats
*--------------------------------------------------------------------*
    ep_num_formats = zcl_xslx2_style_number_format=>mt_built_in_num_formats.
...
*--------------------------------------------------------------------*
  ...
  METHOD load_theme.
    DATA theme TYPE REF TO zcl_xslx2_theme.
...
*--------------------------------------------------------------------*
    ...
    DATA:
      ...
      lv_worksheet_title         TYPE zxslx2_sheet_title,
...
*--------------------------------------------------------------------*
      ...
      lv_zexcel_active_worksheet TYPE zxslx2_active_worksheet,
*--------------------------------------------------------------------*
* issue#235 - repeat rows/columns  - added autofilter support while changing this section
      lo_autofilter              TYPE REF TO zcl_xslx2_autofilter,
      ls_area                    TYPE zxslx2_s_autofilter_area,
      lv_col_start_alpha         TYPE zxslx2_cell_column_alpha,
      lv_col_end_alpha           TYPE zxslx2_cell_column_alpha,
      lv_row_start               TYPE zxslx2_cell_row,
      lv_row_end                 TYPE zxslx2_cell_row,
      lv_regex                   TYPE string,
      lv_range_value_1           TYPE zxslx2_range_value,
      lv_range_value_2           TYPE zxslx2_range_value.
*--------------------------------------------------------------------*
...
*--------------------------------------------------------------------*
      CASE ls_sheet-state.
        ...
        WHEN lcv_worksheet_state_hidden.
          lo_worksheet->zif_xslx2_sheet_properties~hidden = zif_xslx2_sheet_properties=>c_hidden.

        WHEN lcv_worksheet_state_veryhidden.
          lo_worksheet->zif_xslx2_sheet_properties~hidden = zif_xslx2_sheet_properties=>c_veryhidden.
...
* insert autofilters
*--------------------------------------------------------------------*
            WHEN zcl_xslx2_autofilters=>c_autofilter.
              " begin Dennis Schaaf
              TRY.
                  zcl_xslx2_common=>convert_range2column_a_row( EXPORTING i_range        = lv_range_value
                  ...
                  ls_area-col_start = zcl_xslx2_common=>convert_column2int( lv_col_start_alpha ).
                  ls_area-col_end   = zcl_xslx2_common=>convert_column2int( lv_col_end_alpha ).
...
*--------------------------------------------------------------------*
            WHEN zif_xslx2_sheet_printsettings=>gcv_print_title_name.
...
* Split into two ranges if necessary
              ...
              ENDIF.
* 1st range
              zcl_xslx2_common=>convert_range2column_a_row( EXPORTING i_range            = lv_range_value_1
              ...
              IF lv_col_start_alpha IS NOT INITIAL.
                <worksheet>-worksheet->zif_xslx2_sheet_printsettings~set_print_repeat_columns( iv_columns_from = lv_col_start_alpha
                                                                                      iv_columns_to   = lv_col_end_alpha ).
              ENDIF.
              IF lv_row_start IS NOT INITIAL.
                <worksheet>-worksheet->zif_xslx2_sheet_printsettings~set_print_repeat_rows( iv_rows_from = lv_row_start
                                                                                   iv_rows_to   = lv_row_end ).
              ENDIF.

* 2nd range
              zcl_xslx2_common=>convert_range2column_a_row( EXPORTING i_range            = lv_range_value_2
                                                                      i_allow_1dim_range = abap_true
                                                            IMPORTING e_column_start     = lv_col_start_alpha
                                                                      e_column_end       = lv_col_end_alpha
                                                                      e_row_start        = lv_row_start
...
*--------------------------------------------------------------------*
    ...
    TYPES: BEGIN OF lty_sheetview,
             showgridlines            TYPE zxslx2_show_gridlines,
    ...
    TYPES: BEGIN OF lty_datavalidation,
             type             TYPE zxslx2_data_val_type,
             allowblank       TYPE flag,
             showinputmessage TYPE flag,
             showerrormessage TYPE flag,
             showdropdown     TYPE flag,
             operator         TYPE zxslx2_data_val_operator,
             formula1         TYPE zxslx2_validation_formula1,
             formula2         TYPE zxslx2_validation_formula1,
             sqref            TYPE string,
             cell_column      TYPE zxslx2_cell_column_alpha,
             cell_column_to   TYPE zxslx2_cell_column_alpha,
             cell_row         TYPE zxslx2_cell_row,
             cell_row_to      TYPE zxslx2_cell_row,
             error            TYPE string,
             errortitle       TYPE string,
             prompt           TYPE string,
             prompttitle      TYPE string,
             errorstyle       TYPE zxslx2_data_val_error_style,
    ...
    DATA: lo_ixml_worksheet           TYPE REF TO if_ixml_document,
          ...
          lv_cell_formula             TYPE zxslx2_cell_formula,
          lv_cell_column              TYPE zxslx2_cell_column_alpha,
          lv_cell_row                 TYPE zxslx2_cell_row,
          lo_excel_style              TYPE REF TO zcl_xslx2_style,
          ...
          ls_excel_pane               TYPE zxslx2_pane,
          lv_pane_cell_row            TYPE zxslx2_cell_row,
          lv_pane_cell_col_a          TYPE zxslx2_cell_column_alpha,
          lv_pane_cell_col            TYPE zxslx2_cell_column,
          ...
          lv_merge_column_start       TYPE zxslx2_cell_column_alpha,
          lv_merge_column_end         TYPE zxslx2_cell_column_alpha,
          lv_merge_row_start          TYPE zxslx2_cell_row,
          lv_merge_row_end            TYPE zxslx2_cell_row,
          ...
          ls_odd_header               TYPE zxslx2_s_worksheet_head_foot,
          ...
          ls_excel_s_tabcolor         TYPE zxslx2_s_tabcolor,
...
*---    End of current code aligning -------------------------------------------------------------------
          ...
          lo_data_validation          TYPE REF TO zcl_xslx2_data_validation,
...
*--------------------------------------------------------------------*
    ...
    TRY.                                                                          " +#222  _rels/xxx.rels might not be present.  If not found there can be no drawings --> just ignore this section
      ...
      CATCH zcx_xslx2.                            "#EC NO_HANDLER +#222
...
*                   in the "load_worksheet_drawing" shouldn't lead to an abortion of the reading
          TRY.
            ...
            CATCH zcx_xslx2. "--> then ignore it
          ENDTRY.
...
* Theme not supported yet
    ...
    TRY.
        me->load_worksheet_tables( io_ixml_worksheet = lo_ixml_worksheet
                                   ...
                                   it_tables         = lt_tables ).
      CATCH zcx_xslx2. " Ignore reading errors - pass everything we were able to identify
    ENDTRY.
...
*        outline_level = condense( row-outlineLevel ).  "For basis 7.02 and higher
      ...
      WHILE lo_ixml_cell_elem IS BOUND.
        ...
        IF ls_cell-r IS NOT INITIAL.
          ...
          zcl_xslx2_common=>convert_columnrow2column_a_row( EXPORTING
        ...
        ELSE.
          ...
          IF lv_cell_column IS INITIAL.
            lv_cell_column = 'A'.
          ELSE.
            lv_cell_column = zcl_xslx2_common=>convert_column2alpha( zcl_xslx2_common=>convert_column2int( lv_cell_column ) + 1 ).
          ENDIF.
        ENDIF.
...
*--------------------------------------------------------------------*
          ...
          IF ls_formula_attributes-t = 'shared'.
            ...
            TRY.
                ...
                ls_ref_formula-column    = zcl_xslx2_common=>convert_column2int( lv_cell_column ).
...
*--------------------------------------------------------------------*
    IF lv_max_col = 0.
      ...
      IF lo_ixml_imension_elem IS BOUND.
        ...
        ENDIF.
        lv_max_col = zcl_xslx2_common=>convert_column2int( lv_dimension_range ).
      ENDIF.
    ENDIF.
*--------------------------------------------------------------------*
    ...
    WHILE lo_ixml_column_elem IS BOUND.
      ...
      IF   ls_column-customwidth   = lc_xml_attr_true
        ...
        WHILE lv_index <= ls_column-max AND lv_index <= lv_max_col.
          ...
          lv_column_alpha = zcl_xslx2_common=>convert_column2alpha( lv_index ).
          ...
          IF ls_column-style > ''.
            ...
            DATA: dummy_zexcel_cell_style TYPE zxslx2_cell_style.
...
* issue #367 - hide columns from
      IF ls_column-max = zcl_xslx2_common=>c_excel_sheet_max_col.     " Max = very right column
        IF ( ls_column-hidden = lc_xml_attr_true
          OR ls_column-hidden = lc_xml_attr_true_int ) " all hidden
          AND ls_column-min > 0.
          io_worksheet->zif_xslx2_sheet_properties~hide_columns_from = zcl_xslx2_common=>convert_column2alpha( ls_column-min ).
        ELSEIF ls_column-style > ''.
          lv_index_temp = ls_column-style + 1.
          READ TABLE styles INTO lo_excel_style INDEX lv_index_temp.
          dummy_zexcel_cell_style = lo_excel_style->get_guid( ).
* Set style for remaining columns
          io_worksheet->zif_xslx2_sheet_properties~set_style( dummy_zexcel_cell_style ).
        ENDIF.
      ENDIF.
    ...
    IF ls_sheetview-righttoleft = lc_xml_attr_true
      ...
      io_worksheet->zif_xslx2_sheet_properties~set_right_to_left( abap_true ).
    ENDIF.
    io_worksheet->zif_xslx2_sheet_properties~zoomscale                 = ls_sheetview-zoomscale.
    io_worksheet->zif_xslx2_sheet_properties~zoomscale_normal          = ls_sheetview-zoomscalenormal.
    io_worksheet->zif_xslx2_sheet_properties~zoomscale_pagelayoutview  = ls_sheetview-zoomscalepagelayoutview.
    io_worksheet->zif_xslx2_sheet_properties~zoomscale_sheetlayoutview = ls_sheetview-zoomscalesheetlayoutview.
    ...
    WHILE lo_ixml_mergecell_elem IS BOUND.
      ...
      zcl_xslx2_common=>convert_range2column_a_row( EXPORTING
...
*        2do§1   Header/footer
    ...
    TRY.
      ...
      CATCH zcx_xslx2. " Ignore Hyperlink reading errors - pass everything we were able to identify
    ENDTRY.
    ...
    TRY.
        me->load_worksheet_pagebreaks( io_ixml_worksheet      = lo_ixml_worksheet
                                       io_worksheet           = io_worksheet ).
      CATCH zcx_xslx2. " Ignore pagebreak reading errors - pass everything we were able to identify
    ENDTRY.

    TRY.
        me->load_worksheet_autofilter( io_ixml_worksheet      = lo_ixml_worksheet
                                       io_worksheet           = io_worksheet ).
      CATCH zcx_xslx2. " Ignore autofilter reading errors - pass everything we were able to identify
    ENDTRY.

    TRY.
        me->load_worksheet_ignored_errors( io_ixml_worksheet      = lo_ixml_worksheet
                                           io_worksheet           = io_worksheet ).
      CATCH zcx_xslx2. " Ignore "ignoredErrors" reading errors - pass everything we were able to identify
    ENDTRY.
  ...
  METHOD load_worksheet_autofilter.
    ...
    DATA: lo_ixml_autofilter_elem    TYPE REF TO if_ixml_element,
          ...
          lv_val                     TYPE string,
          lo_autofilters             TYPE REF TO zcl_xslx2_autofilters,
          lo_autofilter              TYPE REF TO zcl_xslx2_autofilter.
  ...
  METHOD load_worksheet_cond_format.
    ...
    DATA: lo_ixml_cond_formats TYPE REF TO if_ixml_node_collection,
          ...
          lo_style_cond2       TYPE REF TO zcl_xslx2_style_cond.


    DATA: lv_area           TYPE string,
          lt_areas          TYPE STANDARD TABLE OF string WITH NON-UNIQUE DEFAULT KEY,
          lv_area_start_row TYPE zxslx2_cell_row,
          lv_area_end_row   TYPE zxslx2_cell_row,
          lv_area_start_col TYPE zxslx2_cell_column_alpha,
          lv_area_end_col   TYPE zxslx2_cell_column_alpha,
          lv_rule           TYPE zxslx2_condition_rule.
...
*--------------------------------------------------------------------*
        CASE lv_rule.
          ...
          WHEN zcl_xslx2_style_cond=>c_rule_cellis.
...
*--------------------------------------------------------------------*
          ...
          LOOP AT lt_areas INTO lv_area.
            ...
            zcl_xslx2_common=>convert_range2column_a_row( EXPORTING i_range        = lv_area
...
*--------------------------------------------------------------------*
  ...
  METHOD load_worksheet_drawing.
    ...
    WHILE node IS BOUND.
      ...
      path2 = path.
      zcl_xslx2_common=>split_file( EXPORTING ip_file = path2
...
* two-cell anchor ******************
  ...
  METHOD load_comments.
    DATA: lo_comments_xml       TYPE REF TO if_ixml_document,
          ...
          lo_comment            TYPE REF TO zcl_xslx2_comment,
  ...
  METHOD load_worksheet_hyperlinks.
    ...
    DATA: lo_ixml_hyperlinks TYPE REF TO if_ixml_node_collection,
          ...
          lv_row_start       TYPE zxslx2_cell_row,
          lv_row_end         TYPE zxslx2_cell_row,
          lv_column_start    TYPE zxslx2_cell_column_alpha,
          lv_column_end      TYPE zxslx2_cell_column_alpha,
  ...
  METHOD load_worksheet_ignored_errors.
    ...
    DATA: lo_ixml_ignored_errors TYPE REF TO if_ixml_node_collection,
          ...
          lo_ixml_iterator       TYPE REF TO if_ixml_node_iterator,
          ls_ignored_error       TYPE zcl_xslx2_worksheet=>mty_s_ignored_errors,
          lt_ignored_errors      TYPE zcl_xslx2_worksheet=>mty_th_ignored_errors.
  ...
  METHOD load_worksheet_pagebreaks.
    ...
    DATA: lt_pagebreaks TYPE STANDARD TABLE OF zcl_xslx2_worksheet_pagebreaks=>ts_pagebreak_at,
          lo_pagebreaks TYPE REF TO zcl_xslx2_worksheet_pagebreaks.
...
*--------------------------------------------------------------------*
  ...
  METHOD load_worksheet_pagemargins.
    ...
    IF lo_ixml_pagemargins_elem IS NOT INITIAL.
      ...
      io_worksheet->sheet_setup->margin_bottom = zcl_xslx2_common=>excel_string_to_number( ls_pagemargins-bottom ).
      io_worksheet->sheet_setup->margin_footer = zcl_xslx2_common=>excel_string_to_number( ls_pagemargins-footer ).
      io_worksheet->sheet_setup->margin_header = zcl_xslx2_common=>excel_string_to_number( ls_pagemargins-header ).
      io_worksheet->sheet_setup->margin_left   = zcl_xslx2_common=>excel_string_to_number( ls_pagemargins-left   ).
      io_worksheet->sheet_setup->margin_right  = zcl_xslx2_common=>excel_string_to_number( ls_pagemargins-right  ).
      io_worksheet->sheet_setup->margin_top    = zcl_xslx2_common=>excel_string_to_number( ls_pagemargins-top    ).
    ENDIF.
  ...
  METHOD load_worksheet_tables.
    ...
    DATA ls_field_catalog TYPE zxslx2_s_fieldcatalog.
    DATA lo_ixml_iterator TYPE REF TO if_ixml_node_iterator.
    DATA ls_table_settings TYPE zxslx2_s_table_settings.
    ...
    FIELD-SYMBOLS <ls_field> TYPE zxslx2_s_fieldcatalog.
...
*--------------------------------------------------------------------*
  ...
  METHOD resolve_referenced_formulae.
    ...
    DATA: ls_ref_formula       LIKE LINE OF me->mt_ref_formulae,
          ...
          lv_col_from          TYPE zxslx2_cell_column_alpha,
          lv_col_to            TYPE zxslx2_cell_column_alpha,
...
*--------------------------------------------------------------------*
    LOOP AT me->mt_ref_formulae INTO ls_ref_formula WHERE ref <> space. "#EC CI_HASHSEQ
      ...
      TRY.
          zcl_xslx2_common=>convert_range2column_a_row( EXPORTING i_range        = ls_ref_formula-ref
          ...
          ls_referenced_cell-col_from = zcl_xslx2_common=>convert_column2int( lv_col_from ).
          ls_referenced_cell-col_to   = zcl_xslx2_common=>convert_column2int( lv_col_to ).


          CLEAR ls_referenced_cell-ref_cell.
          TRY.
              ls_referenced_cell-ref_cell(3) = zcl_xslx2_common=>convert_column2alpha( ls_ref_formula-column ).
...
*--------------------------------------------------------------------*
    LOOP AT me->mt_ref_formulae INTO ls_ref_formula WHERE ref = space. "#EC CI_HASHSEQ
      ...
      TRY.
          lv_current_cell(3) = zcl_xslx2_common=>convert_column2alpha( ls_ref_formula-column ).
      ...
      LOOP AT lts_referenced_cells INTO ls_referenced_cell WHERE sheet     = ls_ref_formula-sheet
        ...
        TRY.
            ...
            lv_resulting_formula = zcl_xslx2_common=>determine_resulting_formula( iv_reference_cell     = ls_referenced_cell-ref_cell
...
*--------------------------------------------------------------------*
  ...
  METHOD zif_xslx2_reader~load_file.
...
*--------------------------------------------------------------------*
    r_excel = zif_xslx2_reader~load( i_excel2007            = lv_excel_data
                                     i_use_alternate_zip    = i_use_alternate_zip
