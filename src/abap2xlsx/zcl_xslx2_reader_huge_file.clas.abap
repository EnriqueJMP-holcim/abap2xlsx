CLASS zcl_xslx2_reader_huge_file DEFINITION
  PUBLIC
  INHERITING FROM zcl_xslx2_reader_2007
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF t_cell_content,
        datatype TYPE zxslx2_cell_data_type,
        value    TYPE zxslx2_cell_value,
        formula  TYPE zxslx2_cell_formula,
        style    TYPE zxslx2_cell_style,
      END OF t_cell_content .
    TYPES:
      BEGIN OF t_cell_coord,
        row    TYPE zxslx2_cell_row,
        column TYPE zxslx2_cell_column_alpha,
      END OF t_cell_coord .
    TYPES:
      BEGIN OF t_cell.
    ...
    METHODS get_style
      IMPORTING
        !iv_index            TYPE any
      RETURNING
        VALUE(ev_style_guid) TYPE zxslx2_cell_style
      RAISING
        lcx_not_found .
...
CLASS zcl_xslx2_reader_huge_file IMPLEMENTATION.
  ...
  METHOD load_worksheet.
    ...
    TRY.
      ...
      CATCH lcx_not_found INTO lx_not_found.
        zcx_xslx2=>raise_text( lx_not_found->error ).
    ENDTRY.
  ENDMETHOD.
