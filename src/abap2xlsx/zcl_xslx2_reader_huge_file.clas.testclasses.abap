...
CLASS zcl_xslx2_reader_huge_file DEFINITION LOCAL FRIENDS lcl_test.
...
CLASS lcl_test DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    DATA:
      out       TYPE REF TO zcl_xslx2_reader_huge_file, " object under test
    ...
    METHODS:
      ...
      assert_style_equals IMPORTING iv_row TYPE i DEFAULT 1 iv_col TYPE i DEFAULT 1 iv_style TYPE zxslx2_cell_style,
...
*
  METHOD test_shared_string.
    DATA: lo_reader TYPE REF TO if_sxml_reader,
          lo_ex     TYPE REF TO lcx_not_found,
          lv_text   TYPE string.
    DATA: ls_shared_string TYPE zcl_xslx2_reader_huge_file=>t_shared_string.
...
*
  METHOD test_style.
    DATA: lo_reader TYPE REF TO if_sxml_reader,
          ...
          lv_guid   TYPE zxslx2_cell_style.
...
*
  METHOD assert_value_equals.
    ...
    FIELD-SYMBOLS: <ls_cell_data> TYPE zxslx2_s_cell_data,
