CLASS zcl_xslx2_reader_xlsm DEFINITION
  PUBLIC
...
CLASS zcl_xslx2_reader_xlsm IMPLEMENTATION.
  ...
  METHOD load_vbaproject.
    ...
    ip_excel->zif_xslx2_book_vba_project~set_vbaproject( lv_content ).
  ...
  METHOD load_workbook.
    ...
    IF node IS BOUND.
      ...
      io_excel->zif_xslx2_book_vba_project~set_codename( fileversion-codename ).
    ENDIF.
    ...
    IF node IS BOUND.
      ...
      io_excel->zif_xslx2_book_vba_project~set_codename_pr( workbookpr-codename ).
    ENDIF.
  ...
  METHOD load_worksheet.
    ...
    IF node IS BOUND.
      ...
      IF sheetpr-codename IS NOT INITIAL.
        io_worksheet->zif_xslx2_sheet_vba_project~set_codename_pr( sheetpr-codename ).
      ENDIF.
    ENDIF.
  ENDMETHOD.
ENDCLASS.
