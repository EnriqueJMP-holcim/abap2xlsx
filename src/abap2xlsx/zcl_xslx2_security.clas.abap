CLASS zcl_xslx2_security DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    DATA revisionspassword TYPE zxslx2_revisionspassword .
    DATA workbookpassword TYPE zxslx2_workbookpassword .
...
CLASS zcl_xslx2_security IMPLEMENTATION.
