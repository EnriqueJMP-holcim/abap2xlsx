CLASS zcl_xslx2_style DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    DATA font TYPE REF TO zcl_xslx2_style_font .
    DATA fill TYPE REF TO zcl_xslx2_style_fill .
    DATA borders TYPE REF TO zcl_xslx2_style_borders .
    DATA alignment TYPE REF TO zcl_xslx2_style_alignment .
    DATA number_format TYPE REF TO zcl_xslx2_style_number_format .
    DATA protection TYPE REF TO zcl_xslx2_style_protection .
...
CLASS zcl_xslx2_style IMPLEMENTATION.
