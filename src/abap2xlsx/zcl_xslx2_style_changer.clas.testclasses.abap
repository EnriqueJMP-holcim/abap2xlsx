CLASS ltcl_test DEFINITION FOR TESTING DURATION SHORT RISK LEVEL HARMLESS FINAL.
  ...
  PRIVATE SECTION.
    DATA mi_cut       TYPE REF TO zif_xslx2_style_changer.
    DATA mo_excel     TYPE REF TO zcl_xslx2.
    DATA mo_worksheet TYPE REF TO zcl_xslx2_worksheet.
...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD setup.
    ...
    mi_cut = zcl_xslx2_style_changer=>create( mo_excel ).
  ENDMETHOD.

  METHOD apply.

    DATA lv_guid TYPE zxslx2_cell_style.
