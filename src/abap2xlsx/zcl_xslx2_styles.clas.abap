CLASS zcl_xslx2_styles DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    METHODS register_new_style
      IMPORTING
        !io_style            TYPE REF TO zcl_xslx2_style
      RETURNING
...
*"* do not include other source files here!!!
  ...
  PRIVATE SECTION.
    ...
    DATA styles TYPE REF TO zcl_xslx2_collection .
ENDCLASS.



CLASS zcl_xslx2_styles IMPLEMENTATION.
