CLASS zcl_xslx2_template_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: tt_sheet_titles TYPE STANDARD TABLE OF zxslx2_sheet_title WITH DEFAULT KEY,
...
CLASS zcl_xslx2_template_data IMPLEMENTATION.
