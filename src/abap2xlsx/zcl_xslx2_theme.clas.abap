CLASS zcl_xslx2_theme DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS set_color
      IMPORTING
        iv_type         TYPE string
        iv_srgb         TYPE zcl_xslx2_theme_color_scheme=>t_srgb OPTIONAL
        iv_syscolorname TYPE string OPTIONAL
        iv_syscolorlast TYPE zcl_xslx2_theme_color_scheme=>t_srgb OPTIONAL .
  ...
  PROTECTED SECTION.
    ...
    DATA elements TYPE REF TO zcl_xslx2_theme_elements .
    DATA objectdefaults TYPE REF TO zcl_xslx2_theme_objectdefaults .
    DATA extclrschemelst TYPE REF TO zcl_xslx2_theme_eclrschemelst .
    DATA extlst TYPE REF TO zcl_xslx2_theme_extlst .
  PRIVATE SECTION.
...
CLASS zcl_xslx2_theme IMPLEMENTATION.
