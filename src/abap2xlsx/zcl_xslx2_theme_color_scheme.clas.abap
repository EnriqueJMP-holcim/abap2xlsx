CLASS zcl_xslx2_theme_color_scheme DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC

  GLOBAL FRIENDS zcl_xslx2_theme
                 zcl_xslx2_theme_elements .
...
CLASS zcl_xslx2_theme_color_scheme IMPLEMENTATION.
  ...
  METHOD build_xml.
    ...
    lo_elements ?= io_document->find_from_name_ns( name   = zcl_xslx2_theme=>c_theme_elements ).
    IF lo_elements IS BOUND.
      lo_scheme_element ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix
                                                                  name   = zcl_xslx2_theme_elements=>c_color_scheme
                                                               parent = lo_elements ).
      lo_scheme_element->set_attribute( name = c_name value = name ).

      " Adding colors to scheme
      lo_color ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix
                                                                  name   = c_dark1
                                                      parent = lo_scheme_element ).
      IF lo_color IS BOUND.
        IF dark1-srgb IS NOT INITIAL.
          lo_srgb ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_srgbcolor
                                                         parent = lo_color ).
          lo_srgb->set_attribute( name = c_val value = dark1-srgb ).
        ELSE.
          lo_syscolor ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_syscolor
                                                          parent = lo_color ).
      ...
      lo_color ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_light1
                                                      parent = lo_scheme_element ).
      IF lo_color IS BOUND.
      ...
      lo_color ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_dark2
                                                      parent = lo_scheme_element ).
      IF lo_color IS BOUND.
      ...
      lo_color ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_light2
                                                      parent = lo_scheme_element ).
      IF lo_color IS BOUND.
      ...
      lo_color ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_accent1
                                                      parent = lo_scheme_element ).
      IF lo_color IS BOUND.
      ...
      lo_color ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_accent2
                                                      parent = lo_scheme_element ).
      IF lo_color IS BOUND.
      ...
      lo_color ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_accent3
                                                      parent = lo_scheme_element ).
      IF lo_color IS BOUND.
      ...
      lo_color ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_accent4
                                                      parent = lo_scheme_element ).
      IF lo_color IS BOUND.
      ...
      lo_color ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_accent5
                                                      parent = lo_scheme_element ).
      IF lo_color IS BOUND.
      ...
      lo_color ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_accent6
                                                      parent = lo_scheme_element ).
      IF lo_color IS BOUND.
      ...
      lo_color ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_hlink
                                                      parent = lo_scheme_element ).
      IF lo_color IS BOUND.
      ...
      lo_color ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_folhlink
                                                      parent = lo_scheme_element ).
      IF lo_color IS BOUND.
