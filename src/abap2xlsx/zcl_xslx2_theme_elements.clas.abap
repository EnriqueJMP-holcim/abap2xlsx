CLASS zcl_xslx2_theme_elements DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
  ...
  PROTECTED SECTION.
    ...
    DATA color_scheme TYPE REF TO zcl_xslx2_theme_color_scheme .
    DATA font_scheme TYPE REF TO zcl_xslx2_theme_font_scheme .
    DATA fmt_scheme TYPE REF TO zcl_xslx2_theme_fmt_scheme .
  PRIVATE SECTION.
ENDCLASS.



CLASS zcl_xslx2_theme_elements IMPLEMENTATION.
  ...
  METHOD build_xml.
    ...
    IF lo_theme IS BOUND.
      lo_theme_element ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix
