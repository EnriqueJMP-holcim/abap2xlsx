CLASS zcl_xslx2_theme_fmt_scheme DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_xslx2_theme_fmt_scheme IMPLEMENTATION.
  ...
  METHOD load.
    fmt_scheme = zcl_xslx2_common=>clone_ixml_with_namespaces( io_fmt_scheme ).
  ENDMETHOD.                    "load
