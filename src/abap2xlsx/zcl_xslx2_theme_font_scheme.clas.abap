CLASS zcl_xslx2_theme_font_scheme DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_xslx2_theme_font_scheme IMPLEMENTATION.
  ...
  METHOD build_xml.
    ...
    IF lo_elements IS BOUND.
      lo_scheme_element ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = zcl_xslx2_theme_elements=>c_font_scheme
                                                               parent = lo_elements ).
      lo_scheme_element->set_attribute( name = c_name value = font_scheme-name ).

      lo_major ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_major
                                                      parent = lo_scheme_element ).
      IF lo_major IS BOUND.
        lo_latin ?=  io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_latin
                                                         parent = lo_major ).
        ...
        lo_ea ?=  io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_ea
                                                         parent = lo_major ).
        ...
        lo_cs ?=  io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_cs
                                                      parent = lo_major ).
        ...
        LOOP AT font_scheme-major-fonts ASSIGNING <font>.
          IF <font>-script IS NOT INITIAL AND <font>-typeface IS NOT INITIAL.
            CLEAR lo_font.
            lo_font ?=  io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_font
                                                           parent = lo_major ).
      ...
      lo_minor ?= io_document->create_simple_element_ns( prefix = zcl_xslx2_theme=>c_theme_prefix  name   = c_minor
                                                      parent = lo_scheme_element ).
