CLASS zcl_xslx2_worksheet DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
    ...
    INTERFACES zif_xslx2_sheet_printsettings .
    INTERFACES zif_xslx2_sheet_properties .
    INTERFACES zif_xslx2_sheet_protection .
    INTERFACES zif_xslx2_sheet_vba_project .
    ...
    TYPES:
      BEGIN OF mty_s_ignored_errors,
        ...
        cell_coords           TYPE zxslx2_cell_coords,
    ...
    TYPES:
      BEGIN OF mty_s_column_formula,
        id                     TYPE i,
        column                 TYPE zxslx2_cell_column,
        formula                TYPE string,
        table_top_left_row     TYPE zxslx2_cell_row,
        table_bottom_right_row TYPE zxslx2_cell_row,
        table_left_column_int  TYPE zxslx2_cell_column,
        table_right_column_int TYPE zxslx2_cell_column,
    ...
    CONSTANTS c_break_column TYPE zxslx2_break VALUE 2 ##NO_TEXT.
    CONSTANTS c_break_none TYPE zxslx2_break VALUE 0 ##NO_TEXT.
    CONSTANTS c_break_row TYPE zxslx2_break VALUE 1 ##NO_TEXT.
    CONSTANTS:
      BEGIN OF c_area,
        whole   TYPE ty_area VALUE 'W',                     "#EC NOTEXT
        topleft TYPE ty_area VALUE 'T',                     "#EC NOTEXT
      END OF c_area .
    DATA excel TYPE REF TO zcl_xslx2 READ-ONLY .
    DATA print_gridlines TYPE zxslx2_print_gridlines READ-ONLY VALUE abap_false ##NO_TEXT.
    DATA sheet_content TYPE zxslx2_t_cell_data .
    DATA sheet_setup TYPE REF TO zcl_xslx2_sheet_setup .
    DATA show_gridlines TYPE zxslx2_show_gridlines READ-ONLY VALUE abap_true ##NO_TEXT.
    DATA show_rowcolheaders TYPE zxslx2_show_gridlines READ-ONLY VALUE abap_true ##NO_TEXT.
    DATA tabcolor TYPE zxslx2_s_tabcolor READ-ONLY .
    ...
    METHODS add_comment
      IMPORTING
        !ip_comment TYPE REF TO zcl_xslx2_comment .
    METHODS add_drawing
      IMPORTING
        !ip_drawing TYPE REF TO zcl_xslx2_drawing .
    METHODS add_new_column
      IMPORTING
        !ip_column       TYPE simple
      RETURNING
        VALUE(eo_column) TYPE REF TO zcl_xslx2_column
      RAISING
        zcx_xslx2 .
    METHODS add_new_style_cond
      ...
      RETURNING
        VALUE(eo_style_cond) TYPE REF TO zcl_xslx2_style_cond .
    METHODS add_new_data_validation
      RETURNING
        VALUE(eo_data_validation) TYPE REF TO zcl_xslx2_data_validation .
    METHODS add_new_range
      RETURNING
        VALUE(eo_range) TYPE REF TO zcl_xslx2_range .
    METHODS add_new_row
      IMPORTING
        !ip_row       TYPE simple
      RETURNING
        VALUE(eo_row) TYPE REF TO zcl_xslx2_row .
    METHODS bind_alv
      IMPORTING
        ...
        !table_style TYPE zxslx2_table_style OPTIONAL
    ...
    METHODS bind_table
      IMPORTING
        ...
        !it_field_catalog       TYPE zxslx2_t_fieldcatalog OPTIONAL
        !is_table_settings      TYPE zxslx2_s_table_settings OPTIONAL
      ...
      EXPORTING
        !es_table_settings      TYPE zxslx2_s_table_settings
      RAISING
        zcx_xslx2 .
    ...
    METHODS change_area_style
      IMPORTING
        ...
        !ip_row           TYPE zxslx2_cell_row OPTIONAL
        !ip_row_to        TYPE zxslx2_cell_row OPTIONAL
        !ip_style_changer TYPE REF TO zif_xslx2_style_changer
      RAISING
        zcx_xslx2 .
    METHODS change_cell_style
      IMPORTING
        ...
        !ip_row                         TYPE zxslx2_cell_row OPTIONAL
        !ip_complete                    TYPE zxslx2_s_cstyle_complete OPTIONAL
        !ip_xcomplete                   TYPE zxslx2_s_cstylex_complete OPTIONAL
        !ip_font                        TYPE zxslx2_s_cstyle_font OPTIONAL
        !ip_xfont                       TYPE zxslx2_s_cstylex_font OPTIONAL
        !ip_fill                        TYPE zxslx2_s_cstyle_fill OPTIONAL
        !ip_xfill                       TYPE zxslx2_s_cstylex_fill OPTIONAL
        !ip_borders                     TYPE zxslx2_s_cstyle_borders OPTIONAL
        !ip_xborders                    TYPE zxslx2_s_cstylex_borders OPTIONAL
        !ip_alignment                   TYPE zxslx2_s_cstyle_alignment OPTIONAL
        !ip_xalignment                  TYPE zxslx2_s_cstylex_alignment OPTIONAL
        !ip_number_format_format_code   TYPE zxslx2_number_format OPTIONAL
        !ip_protection                  TYPE zxslx2_s_cstyle_protection OPTIONAL
        !ip_xprotection                 TYPE zxslx2_s_cstylex_protection OPTIONAL
        !ip_font_bold                   TYPE flag OPTIONAL
        !ip_font_color                  TYPE zxslx2_s_style_color OPTIONAL
        !ip_font_color_rgb              TYPE zxslx2_style_color_argb OPTIONAL
        !ip_font_color_indexed          TYPE zxslx2_style_color_indexed OPTIONAL
        !ip_font_color_theme            TYPE zxslx2_style_color_theme OPTIONAL
        !ip_font_color_tint             TYPE zxslx2_style_color_tint OPTIONAL
        !ip_font_family                 TYPE zxslx2_style_font_family OPTIONAL
        !ip_font_italic                 TYPE flag OPTIONAL
        !ip_font_name                   TYPE zxslx2_style_font_name OPTIONAL
        !ip_font_scheme                 TYPE zxslx2_style_font_scheme OPTIONAL
        !ip_font_size                   TYPE zxslx2_style_font_size OPTIONAL
        !ip_font_strikethrough          TYPE flag OPTIONAL
        !ip_font_underline              TYPE flag OPTIONAL
        !ip_font_underline_mode         TYPE zxslx2_style_font_underline OPTIONAL
        !ip_fill_filltype               TYPE zxslx2_fill_type OPTIONAL
        !ip_fill_rotation               TYPE zxslx2_rotation OPTIONAL
        !ip_fill_fgcolor                TYPE zxslx2_s_style_color OPTIONAL
        !ip_fill_fgcolor_rgb            TYPE zxslx2_style_color_argb OPTIONAL
        !ip_fill_fgcolor_indexed        TYPE zxslx2_style_color_indexed OPTIONAL
        !ip_fill_fgcolor_theme          TYPE zxslx2_style_color_theme OPTIONAL
        !ip_fill_fgcolor_tint           TYPE zxslx2_style_color_tint OPTIONAL
        !ip_fill_bgcolor                TYPE zxslx2_s_style_color OPTIONAL
        !ip_fill_bgcolor_rgb            TYPE zxslx2_style_color_argb OPTIONAL
        !ip_fill_bgcolor_indexed        TYPE zxslx2_style_color_indexed OPTIONAL
        !ip_fill_bgcolor_theme          TYPE zxslx2_style_color_theme OPTIONAL
        !ip_fill_bgcolor_tint           TYPE zxslx2_style_color_tint OPTIONAL
        !ip_borders_allborders          TYPE zxslx2_s_cstyle_border OPTIONAL
        !ip_fill_gradtype_type          TYPE zxslx2_s_gradient_type-type OPTIONAL
        !ip_fill_gradtype_degree        TYPE zxslx2_s_gradient_type-degree OPTIONAL
        !ip_xborders_allborders         TYPE zxslx2_s_cstylex_border OPTIONAL
        !ip_borders_diagonal            TYPE zxslx2_s_cstyle_border OPTIONAL
        !ip_fill_gradtype_bottom        TYPE zxslx2_s_gradient_type-bottom OPTIONAL
        !ip_fill_gradtype_top           TYPE zxslx2_s_gradient_type-top OPTIONAL
        !ip_xborders_diagonal           TYPE zxslx2_s_cstylex_border OPTIONAL
        !ip_borders_diagonal_mode       TYPE zxslx2_diagonal OPTIONAL
        !ip_fill_gradtype_right         TYPE zxslx2_s_gradient_type-right OPTIONAL
        !ip_borders_down                TYPE zxslx2_s_cstyle_border OPTIONAL
        !ip_fill_gradtype_left          TYPE zxslx2_s_gradient_type-left OPTIONAL
        !ip_fill_gradtype_position1     TYPE zxslx2_s_gradient_type-position1 OPTIONAL
        !ip_xborders_down               TYPE zxslx2_s_cstylex_border OPTIONAL
        !ip_borders_left                TYPE zxslx2_s_cstyle_border OPTIONAL
        !ip_fill_gradtype_position2     TYPE zxslx2_s_gradient_type-position2 OPTIONAL
        !ip_fill_gradtype_position3     TYPE zxslx2_s_gradient_type-position3 OPTIONAL
        !ip_xborders_left               TYPE zxslx2_s_cstylex_border OPTIONAL
        !ip_borders_right               TYPE zxslx2_s_cstyle_border OPTIONAL
        !ip_xborders_right              TYPE zxslx2_s_cstylex_border OPTIONAL
        !ip_borders_top                 TYPE zxslx2_s_cstyle_border OPTIONAL
        !ip_xborders_top                TYPE zxslx2_s_cstylex_border OPTIONAL
        !ip_alignment_horizontal        TYPE zxslx2_alignment OPTIONAL
        !ip_alignment_vertical          TYPE zxslx2_alignment OPTIONAL
        !ip_alignment_textrotation      TYPE zxslx2_text_rotation OPTIONAL
        !ip_alignment_wraptext          TYPE flag OPTIONAL
        !ip_alignment_shrinktofit       TYPE flag OPTIONAL
        !ip_alignment_indent            TYPE zxslx2_indent OPTIONAL
        !ip_protection_hidden           TYPE zxslx2_cell_protection OPTIONAL
        !ip_protection_locked           TYPE zxslx2_cell_protection OPTIONAL
        !ip_borders_allborders_style    TYPE zxslx2_border OPTIONAL
        !ip_borders_allborders_color    TYPE zxslx2_s_style_color OPTIONAL
        !ip_borders_allbo_color_rgb     TYPE zxslx2_style_color_argb OPTIONAL
        !ip_borders_allbo_color_indexed TYPE zxslx2_style_color_indexed OPTIONAL
        !ip_borders_allbo_color_theme   TYPE zxslx2_style_color_theme OPTIONAL
        !ip_borders_allbo_color_tint    TYPE zxslx2_style_color_tint OPTIONAL
        !ip_borders_diagonal_style      TYPE zxslx2_border OPTIONAL
        !ip_borders_diagonal_color      TYPE zxslx2_s_style_color OPTIONAL
        !ip_borders_diagonal_color_rgb  TYPE zxslx2_style_color_argb OPTIONAL
        !ip_borders_diagonal_color_inde TYPE zxslx2_style_color_indexed OPTIONAL
        !ip_borders_diagonal_color_them TYPE zxslx2_style_color_theme OPTIONAL
        !ip_borders_diagonal_color_tint TYPE zxslx2_style_color_tint OPTIONAL
        !ip_borders_down_style          TYPE zxslx2_border OPTIONAL
        !ip_borders_down_color          TYPE zxslx2_s_style_color OPTIONAL
        !ip_borders_down_color_rgb      TYPE zxslx2_style_color_argb OPTIONAL
        !ip_borders_down_color_indexed  TYPE zxslx2_style_color_indexed OPTIONAL
        !ip_borders_down_color_theme    TYPE zxslx2_style_color_theme OPTIONAL
        !ip_borders_down_color_tint     TYPE zxslx2_style_color_tint OPTIONAL
        !ip_borders_left_style          TYPE zxslx2_border OPTIONAL
        !ip_borders_left_color          TYPE zxslx2_s_style_color OPTIONAL
        !ip_borders_left_color_rgb      TYPE zxslx2_style_color_argb OPTIONAL
        !ip_borders_left_color_indexed  TYPE zxslx2_style_color_indexed OPTIONAL
        !ip_borders_left_color_theme    TYPE zxslx2_style_color_theme OPTIONAL
        !ip_borders_left_color_tint     TYPE zxslx2_style_color_tint OPTIONAL
        !ip_borders_right_style         TYPE zxslx2_border OPTIONAL
        !ip_borders_right_color         TYPE zxslx2_s_style_color OPTIONAL
        !ip_borders_right_color_rgb     TYPE zxslx2_style_color_argb OPTIONAL
        !ip_borders_right_color_indexed TYPE zxslx2_style_color_indexed OPTIONAL
        !ip_borders_right_color_theme   TYPE zxslx2_style_color_theme OPTIONAL
        !ip_borders_right_color_tint    TYPE zxslx2_style_color_tint OPTIONAL
        !ip_borders_top_style           TYPE zxslx2_border OPTIONAL
        !ip_borders_top_color           TYPE zxslx2_s_style_color OPTIONAL
        !ip_borders_top_color_rgb       TYPE zxslx2_style_color_argb OPTIONAL
        !ip_borders_top_color_indexed   TYPE zxslx2_style_color_indexed OPTIONAL
        !ip_borders_top_color_theme     TYPE zxslx2_style_color_theme OPTIONAL
        !ip_borders_top_color_tint      TYPE zxslx2_style_color_tint OPTIONAL
      RETURNING
        VALUE(ep_guid)                  TYPE zxslx2_cell_style
      RAISING
        zcx_xslx2 .
    CLASS-METHODS class_constructor .
    METHODS constructor
      IMPORTING
        !ip_excel TYPE REF TO zcl_xslx2
        !ip_title TYPE zxslx2_sheet_title OPTIONAL
      RAISING
        zcx_xslx2 .
    METHODS delete_merge
      IMPORTING
        !ip_cell_column TYPE simple OPTIONAL
        !ip_cell_row    TYPE zxslx2_cell_row OPTIONAL
      RAISING
        zcx_xslx2 .
    ...
    METHODS get_cell
      IMPORTING
        ...
        !ip_row       TYPE zxslx2_cell_row OPTIONAL
      EXPORTING
        !ep_value     TYPE zxslx2_cell_value
        !ep_rc        TYPE sysubrc
        !ep_style     TYPE REF TO zcl_xslx2_style
        !ep_guid      TYPE zxslx2_cell_style
        !ep_formula   TYPE zxslx2_cell_formula
        !et_rtf       TYPE zxslx2_t_rtf
      RAISING
        zcx_xslx2 .
    METHODS get_column
      IMPORTING
    ...
    METHODS get_columns
      RETURNING
        VALUE(eo_columns) TYPE REF TO zcl_xslx2_columns
      RAISING
        zcx_xslx2 .
    METHODS get_columns_iterator
      RETURNING
        VALUE(eo_iterator) TYPE REF TO zcl_xslx2_collection_iterator
      RAISING
        zcx_xslx2 .
    ...
    METHODS get_default_excel_date_format
      RETURNING
        VALUE(ep_default_excel_date_format) TYPE zxslx2_number_format .
    METHODS get_default_excel_time_format
      RETURNING
        VALUE(ep_default_excel_time_format) TYPE zxslx2_number_format .
    ...
    METHODS get_comments
      ...
      RETURNING
        VALUE(r_comments) TYPE REF TO zcl_xslx2_comments .
    METHODS get_drawings
      IMPORTING
        !ip_type          TYPE zxslx2_drawing_type OPTIONAL
      RETURNING
        VALUE(r_drawings) TYPE REF TO zcl_xslx2_drawings .
    METHODS get_comments_iterator
      RETURNING
        VALUE(eo_iterator) TYPE REF TO zcl_xslx2_collection_iterator .
    METHODS get_drawings_iterator
      IMPORTING
        !ip_type           TYPE zxslx2_drawing_type
      RETURNING
        VALUE(eo_iterator) TYPE REF TO zcl_xslx2_collection_iterator .
    METHODS get_freeze_cell
      EXPORTING
        !ep_row    TYPE zxslx2_cell_row
        !ep_column TYPE zxslx2_cell_column .
    METHODS get_guid
      RETURNING
        VALUE(ep_guid) TYPE sysuuid_x16 .
    METHODS get_highest_column
      RETURNING
        VALUE(r_highest_column) TYPE zxslx2_cell_column
      RAISING
        zcx_xslx2 .
    ...
    METHODS get_pagebreaks
      RETURNING
        VALUE(ro_pagebreaks) TYPE REF TO zcl_xslx2_worksheet_pagebreaks
      RAISING
        zcx_xslx2 .
    ...
    METHODS get_rows
      RETURNING
        VALUE(eo_rows) TYPE REF TO zcl_xslx2_rows .
    ...
    METHODS get_style_cond
      IMPORTING
        !ip_guid             TYPE zxslx2_cell_style
      RETURNING
        VALUE(eo_style_cond) TYPE REF TO zcl_xslx2_style_cond .
    METHODS get_tabcolor
      RETURNING
        VALUE(ev_tabcolor) TYPE zxslx2_s_tabcolor .
    ...
    METHODS get_title
      ...
      RETURNING
        VALUE(ep_title) TYPE zxslx2_sheet_title .
    METHODS is_cell_merged
      IMPORTING
        !ip_column          TYPE simple
        !ip_row             TYPE zxslx2_cell_row
      RETURNING
    ...
    METHODS set_cell
      IMPORTING
        ...
        !ip_formula           TYPE zxslx2_cell_formula OPTIONAL
        !ip_style             TYPE any OPTIONAL
        !ip_hyperlink         TYPE REF TO zcl_xslx2_hyperlink OPTIONAL
        !ip_data_type         TYPE zxslx2_cell_data_type OPTIONAL
        !ip_abap_type         TYPE abap_typekind OPTIONAL
        !ip_currency          TYPE waers_curc OPTIONAL
        !it_rtf               TYPE zxslx2_t_rtf OPTIONAL
    ...
    METHODS set_cell_formula
      IMPORTING
        ...
        !ip_column    TYPE simple OPTIONAL
        !ip_row       TYPE zxslx2_cell_row OPTIONAL
        !ip_formula   TYPE zxslx2_cell_formula
      RAISING
        zcx_xslx2 .
    ...
    METHODS set_default_excel_date_format
      IMPORTING
        !ip_default_excel_date_format TYPE zxslx2_number_format
      RAISING
        zcx_xslx2 .
    ...
    METHODS set_merge
      IMPORTING
        ...
        !ip_formula      TYPE zxslx2_cell_formula OPTIONAL        "added parameter
      RAISING
        zcx_xslx2 .
    ...
    METHODS set_print_gridlines
      IMPORTING
        !i_print_gridlines TYPE zxslx2_print_gridlines .
    ...
    METHODS set_show_gridlines
      IMPORTING
        !i_show_gridlines TYPE zxslx2_show_gridlines .
    METHODS set_show_rowcolheaders
      IMPORTING
        !i_show_rowcolheaders TYPE zxslx2_show_rowcolheader .
    METHODS set_tabcolor
      IMPORTING
        !iv_tabcolor TYPE zxslx2_s_tabcolor .
    METHODS set_table
      IMPORTING
        !ip_table           TYPE STANDARD TABLE
        ...
        !ip_top_left_column TYPE zxslx2_cell_column_alpha DEFAULT 'B'
        !ip_top_left_row    TYPE zxslx2_cell_row DEFAULT 3
    ...
    METHODS set_title
      IMPORTING
        !ip_title TYPE zxslx2_sheet_title
      RAISING
        zcx_xslx2 .
    METHODS get_table
      IMPORTING
    ...
    METHODS get_header_footer_drawings
      RETURNING
        VALUE(rt_drawings) TYPE zxslx2_t_drawings .
  ...
  PROTECTED SECTION.
    METHODS set_table_reference
      IMPORTING
        !ip_column    TYPE zxslx2_cell_column
        !ip_row       TYPE zxslx2_cell_row
        !ir_table     TYPE REF TO zcl_xslx2_table
        !ip_fieldname TYPE zxslx2_fieldname
...
*"* do not include other source files here!!!
    TYPES ty_table_settings TYPE STANDARD TABLE OF zxslx2_s_table_settings WITH DEFAULT KEY.

    CONSTANTS typekind_utclong TYPE abap_typekind VALUE 'p'.

    CLASS-DATA variable_utclong TYPE REF TO data.

    DATA active_cell TYPE zxslx2_s_cell_data .
    DATA charts TYPE REF TO zcl_xslx2_drawings .
    DATA columns TYPE REF TO zcl_xslx2_columns .
    DATA row_default TYPE REF TO zcl_xslx2_row .
    DATA column_default TYPE REF TO zcl_xslx2_column .
    DATA styles_cond TYPE REF TO zcl_xslx2_styles_cond .
    DATA data_validations TYPE REF TO zcl_xslx2_data_validations .
    DATA default_excel_date_format TYPE zxslx2_number_format .
    DATA default_excel_time_format TYPE zxslx2_number_format .
    DATA comments TYPE REF TO zcl_xslx2_comments .
    DATA drawings TYPE REF TO zcl_xslx2_drawings .
    DATA freeze_pane_cell_column TYPE zxslx2_cell_column .
    DATA freeze_pane_cell_row TYPE zxslx2_cell_row .
    DATA guid TYPE sysuuid_x16 .
    DATA hyperlinks TYPE REF TO zcl_xslx2_collection .
    DATA lower_cell TYPE zxslx2_s_cell_data .
    DATA mo_pagebreaks TYPE REF TO zcl_xslx2_worksheet_pagebreaks .
    DATA mt_row_outlines TYPE mty_ts_outlines_row .
    DATA print_title_col_from TYPE zxslx2_cell_column_alpha .
    DATA print_title_col_to TYPE zxslx2_cell_column_alpha .
    DATA print_title_row_from TYPE zxslx2_cell_row .
    DATA print_title_row_to TYPE zxslx2_cell_row .
    DATA ranges TYPE REF TO zcl_xslx2_ranges .
    DATA rows TYPE REF TO zcl_xslx2_rows .
    DATA tables TYPE REF TO zcl_xslx2_collection .
    DATA title TYPE zxslx2_sheet_title VALUE 'Worksheet'. "#EC NOTEXT .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  . " .
    DATA upper_cell TYPE zxslx2_s_cell_data .
    ...
    CLASS-METHODS calculate_table_bottom_right
      IMPORTING
        ip_table         TYPE STANDARD TABLE
        it_field_catalog TYPE zxslx2_t_fieldcatalog
      CHANGING
        cs_settings      TYPE zxslx2_s_table_settings
      RAISING
        zcx_xslx2.
    ...
    METHODS check_rtf
      IMPORTING
        !ip_value       TYPE simple
        VALUE(ip_style) TYPE zxslx2_cell_style OPTIONAL
      CHANGING
        !ct_rtf         TYPE zxslx2_t_rtf
      RAISING
        zcx_xslx2 .
    CLASS-METHODS check_table_overlapping
      IMPORTING
        is_table_settings       TYPE zxslx2_s_table_settings
        it_other_table_settings TYPE ty_table_settings
      RAISING
        zcx_xslx2.
    METHODS clear_initial_colorxfields
      IMPORTING
        is_color  TYPE zxslx2_s_style_color
      CHANGING
        cs_xcolor TYPE zxslx2_s_cstylex_color.
    ...
    METHODS move_supplied_borders
      IMPORTING
        ...
        is_border                 TYPE zxslx2_s_cstyle_border
        iv_xborder_supplied       TYPE abap_bool
        is_xborder                TYPE zxslx2_s_cstylex_border
      CHANGING
        cs_complete_style_border  TYPE zxslx2_s_cstyle_border
        cs_complete_stylex_border TYPE zxslx2_s_cstylex_border.
    METHODS normalize_column_heading_texts
      IMPORTING
        iv_default_descr TYPE c
        it_field_catalog TYPE zxslx2_t_fieldcatalog
      RETURNING
        VALUE(result)    TYPE zxslx2_t_fieldcatalog.
    ...
    METHODS normalize_range_parameter
      IMPORTING
        ...
        ip_row_to       TYPE zxslx2_cell_row OPTIONAL
      EXPORTING
        ep_column_start TYPE zxslx2_cell_column
        ep_column_end   TYPE zxslx2_cell_column
        ep_row          TYPE zxslx2_cell_row
        ep_row_to       TYPE zxslx2_cell_row
      RAISING
        zcx_xslx2.
    CLASS-METHODS normalize_style_parameter
      ...
      RETURNING
        VALUE(rv_guid)    TYPE zxslx2_cell_style
      RAISING
        zcx_xslx2 .
...
CLASS zcl_xslx2_worksheet IMPLEMENTATION.
  ...
  METHOD add_drawing.
    CASE ip_drawing->get_type( ).
      WHEN zcl_xslx2_drawing=>type_image.
        drawings->include( ip_drawing ).
      WHEN zcl_xslx2_drawing=>type_chart.
  ...
  METHOD add_new_column.
    DATA: lv_column_alpha TYPE zxslx2_cell_column_alpha.

    lv_column_alpha = zcl_xslx2_common=>convert_column2alpha( ip_column ).
...
* Create default blank range
  ...
  METHOD bind_alv.
    DATA: lo_converter TYPE REF TO zcl_xslx2_converter.
...
*--------------------------------------------------------------------*
    ...
    CONSTANTS:
      lc_top_left_column TYPE zxslx2_cell_column_alpha VALUE 'A',
      lc_top_left_row    TYPE zxslx2_cell_row VALUE 1,
      lc_no_currency     TYPE waers_curc VALUE IS INITIAL.

    DATA:
      lv_row_int              TYPE zxslx2_cell_row,
      lv_first_row            TYPE zxslx2_cell_row,
      lv_last_row             TYPE zxslx2_cell_row,
      lv_column_int           TYPE zxslx2_cell_column,
      lv_column_alpha         TYPE zxslx2_cell_column_alpha,
      lt_field_catalog        TYPE zxslx2_t_fieldcatalog,
      lv_id                   TYPE i,
      lv_formula              TYPE string,
      ls_settings             TYPE zxslx2_s_table_settings,
      lo_table                TYPE REF TO zcl_xslx2_table,
      lv_value_lowercase      TYPE string,
      lv_syindex              TYPE c LENGTH 3,
      lo_iterator             TYPE REF TO zcl_xslx2_collection_iterator,
      lo_style_cond           TYPE REF TO zcl_xslx2_style_cond,
      lo_curtable             TYPE REF TO zcl_xslx2_table,
      lt_other_table_settings TYPE ty_table_settings.
    DATA: ls_column_formula TYPE mty_s_column_formula,
          lv_mincol         TYPE i.

    FIELD-SYMBOLS:
      <ls_field_catalog>        TYPE zxslx2_s_fieldcatalog,
      <ls_field_catalog_custom> TYPE zxslx2_s_fieldcatalog,
    ...
    IF ls_settings-table_style IS INITIAL.
      ls_settings-table_style = zcl_xslx2_table=>builtinstyle_medium2.
    ENDIF.
    ...
    IF it_field_catalog IS NOT SUPPLIED.
      lt_field_catalog = zcl_xslx2_common=>get_fieldcatalog( ip_table = ip_table
...
* Start filling the table
    ...
    lv_column_int = zcl_xslx2_common=>convert_column2int( ls_settings-top_left_column ).
...
* It is better to loop column by column (only visible column)
    LOOP AT lt_field_catalog ASSIGNING <ls_field_catalog> WHERE dynpfld EQ abap_true.
      ...
      lv_column_alpha = zcl_xslx2_common=>convert_column2alpha( lv_column_int ).
      ...
      IF <ls_field_catalog>-column_formula IS NOT INITIAL.
        ...
        ls_column_formula-table_right_column_int = zcl_xslx2_common=>convert_column2int( lo_table->settings-bottom_right_column ).
...
*--------------------------------------------------------------------*
    ...
    DATA: ld_cell_value                TYPE zxslx2_cell_value,
          ld_style_guid                TYPE zxslx2_cell_style,
          ls_stylemapping              TYPE zxslx2_s_stylemapping,
          lo_table_object              TYPE REF TO object,
          lo_table                     TYPE REF TO zcl_xslx2_table,
          ld_table_top_left_column     TYPE zxslx2_cell_column,
          ld_table_bottom_right_column TYPE zxslx2_cell_column,
          ...
          ld_font_height               TYPE zcl_xslx2_font=>ty_font_height VALUE zcl_xslx2_font=>lc_default_font_height,
          ld_font_name                 TYPE zxslx2_style_font_name VALUE zcl_xslx2_font=>lc_default_font_name.
    ...
    LOOP AT me->tables->collection INTO lo_table_object.
      ...
      ld_table_top_left_column =
        zcl_xslx2_common=>convert_column2int(
    ...
    IF ld_style_guid IS NOT INITIAL.
      TRY.
          ...
          CASE ls_stylemapping-complete_style-number_format-format_code.
            WHEN zcl_xslx2_style_number_format=>c_format_date_std.

              " Convert excel date to ABAP date
              ld_date =
                zcl_xslx2_common=>excel_string_to_date( ld_cell_value ).
            ...
            WHEN get_default_excel_time_format( ).
              ...
              ld_time = zcl_xslx2_common=>excel_string_to_time( ld_cell_value ).
    ...
    ep_width = zcl_xslx2_font=>calculate_text_width(
  ...
  METHOD calculate_column_widths.
    ...
    DATA: lo_column_iterator TYPE REF TO zcl_xslx2_collection_iterator,
          lo_column          TYPE REF TO zcl_xslx2_column.
...
* Do not check merged cells
  ...
  METHOD calculate_table_bottom_right.
    ...
    DATA: lv_errormessage TYPE string,
          lv_columns      TYPE i,
          lt_columns      TYPE zxslx2_t_fieldcatalog,
          lv_maxrow       TYPE i,
          lo_iterator     TYPE REF TO zcl_xslx2_collection_iterator,
          lo_curtable     TYPE REF TO zcl_xslx2_table,
          lv_row_int      TYPE zxslx2_cell_row,
    ...
    lv_column_int = zcl_xslx2_common=>convert_column2int( cs_settings-top_left_column ).
    ...
    cs_settings-bottom_right_column = zcl_xslx2_common=>convert_column2alpha( lv_maxcol ).
  ...
  METHOD change_area_style.
    ...
    DATA: lv_row              TYPE zxslx2_cell_row,
          lv_row_start        TYPE zxslx2_cell_row,
          lv_row_to           TYPE zxslx2_cell_row,
          lv_column_int       TYPE zxslx2_cell_column,
          lv_column_start_int TYPE zxslx2_cell_column,
          lv_column_end_int   TYPE zxslx2_cell_column.
  ...
  METHOD change_cell_style.
    ...
    DATA: changer TYPE REF TO zif_xslx2_style_changer,
          column  TYPE zxslx2_cell_column,
          row     TYPE zxslx2_cell_row.
    ...
    changer = zcl_xslx2_style_changer=>create( excel = excel ).


    IF ip_complete IS SUPPLIED.
      IF ip_xcomplete IS NOT SUPPLIED.
        zcx_xslx2=>raise_text( 'Complete styleinfo has to be supplied with corresponding X-field' ).
      ENDIF.
  ...
  METHOD check_cell_column_formula.
    ...
    FIELD-SYMBOLS <fs_column_formula> TYPE zcl_xslx2_worksheet=>mty_s_column_formula.

    IF ip_value IS NOT INITIAL OR ip_formula IS NOT INITIAL.
      zcx_xslx2=>raise_text( c_messages-formula_id_only_is_possible ).
    ENDIF.
    READ TABLE it_column_formulas WITH TABLE KEY id = ip_column_formula_id ASSIGNING <fs_column_formula>.
    IF sy-subrc <> 0.
      zcx_xslx2=>raise_text( c_messages-column_formula_id_not_found ).
    ENDIF.
    IF ip_row < <fs_column_formula>-table_top_left_row + 1
      ...
      zcx_xslx2=>raise_text( c_messages-formula_not_in_this_table ).
    ENDIF.
    IF ip_column <> <fs_column_formula>-column.
      zcx_xslx2=>raise_text( c_messages-formula_in_other_column ).
    ENDIF.
  ...
  METHOD check_rtf.
    ...
    DATA: lo_style           TYPE REF TO zcl_xslx2_style,
          ls_font            TYPE zxslx2_s_style_font,
    ...
    LOOP AT ct_rtf ASSIGNING <rtf>.
      ...
      ELSEIF lv_next_rtf_offset > <rtf>-offset.
        RAISE EXCEPTION TYPE zcx_xslx2
          EXPORTING
  ...
  METHOD check_table_overlapping.
    ...
    DATA: lv_errormessage TYPE string,
          ...
          lv_maxcol       TYPE i.
    FIELD-SYMBOLS:
          <ls_table_settings> TYPE zxslx2_s_table_settings.

    lv_column_int = zcl_xslx2_common=>convert_column2int( is_table_settings-top_left_column ).
    lv_maxcol = zcl_xslx2_common=>convert_column2int( is_table_settings-bottom_right_column ).
    ...
    LOOP AT it_other_table_settings ASSIGNING <ls_table_settings>.
      ...
      IF  (    (  is_table_settings-top_left_row     GE <ls_table_settings>-top_left_row
        ...
        AND
          (    (  lv_column_int GE zcl_xslx2_common=>convert_column2int( <ls_table_settings>-top_left_column )
              AND lv_column_int LE zcl_xslx2_common=>convert_column2int( <ls_table_settings>-bottom_right_column ) )
            OR
               (  lv_maxcol     GE zcl_xslx2_common=>convert_column2int( <ls_table_settings>-top_left_column )
              AND lv_maxcol     LE zcl_xslx2_common=>convert_column2int( <ls_table_settings>-bottom_right_column ) )
          ).
        lv_errormessage = 'Table overlaps with previously bound table and will not be added to worksheet.'(400).
        zcx_xslx2=>raise_text( lv_errormessage ).
      ENDIF.
  ...
  METHOD constructor.
    DATA: lv_title TYPE zxslx2_sheet_title.

    me->excel = ip_excel.

    me->guid = zcl_xslx2_obsolete_func_wrap=>guid_create( ).        " ins issue #379 - replacement for outdated function call
    ...
    CREATE OBJECT drawings
      EXPORTING
        ip_type = zcl_xslx2_drawing=>type_image.
    CREATE OBJECT charts
      EXPORTING
        ip_type = zcl_xslx2_drawing=>type_chart.
    me->zif_xslx2_sheet_protection~initialize( ).
    me->zif_xslx2_sheet_properties~initialize( ).
  ...
  METHOD convert_to_table.
    ...
    TYPES:
      ...
      BEGIN OF ts_style_conv,
        cell_style TYPE zxslx2_s_cell_data-cell_style,
    ...
    DATA:
      ...
      ls_stylemapping     TYPE zxslx2_s_stylemapping,
      lv_format_code      TYPE zxslx2_number_format,
      lv_float            TYPE f,
    ...
    FIELD-SYMBOLS:
      ...
      <ls_ddic_object>   TYPE x031l,
      <ls_sheet_content> TYPE zxslx2_s_cell_data,
    ...
    IF lt_field_catalog IS INITIAL.
      IF et_data IS SUPPLIED.
        lt_field_catalog = zcl_xslx2_common=>get_fieldcatalog( ip_table = et_data ).
      ELSE.
        DO lv_maxcol TIMES.
...
*      lt_ddic_object = get_ddic_object( et_data ).
    ...
    IF lt_style_conv IS NOT INITIAL.
      ...
      LOOP AT lt_style_conv INTO ls_style_conv.
        ...
        IF lv_format_code CA 'yd' OR lv_format_code EQ zcl_xslx2_style_number_format=>c_format_date_std.
          " DATE = yyyymmdd
          ...
          IF sy-subrc EQ 0 AND <ls_field_conv>-convexit IS NOT INITIAL.
            CASE <ls_field_conv>-convexit.
              WHEN cl_abap_typedescr=>typekind_float.
                lv_float = zcl_xslx2_common=>excel_string_to_number( <ls_sheet_content>-cell_value ).
            ...
            IF sy-subrc EQ 0.
              CASE ls_style_conv-abap_type.
                WHEN cl_abap_typedescr=>typekind_date.
                  <lv_data> = zcl_xslx2_common=>excel_string_to_date( ip_value = <ls_sheet_content>-cell_value
                                                                      ip_exact = abap_true ).
                WHEN cl_abap_typedescr=>typekind_time.
                  <lv_data> = zcl_xslx2_common=>excel_string_to_time( <ls_sheet_content>-cell_value ).
              ENDCASE.
            ENDIF.
          ENDIF.
...
*--------------------------------------------------------------------*
    ...
    ELSE.
      lv_column = zcl_xslx2_common=>convert_column2int( ip_cell_column ).
  ...
  METHOD delete_row_outline.
    ...
    IF sy-subrc <> 0.  " didn't find outline that was to be deleted
      zcx_xslx2=>raise_text( 'Row outline to be deleted does not exist' ).
    ENDIF.
  ...
  METHOD freeze_panes.
    ...
    IF ip_num_columns IS NOT SUPPLIED AND ip_num_rows IS NOT SUPPLIED.
      zcx_xslx2=>raise_text( 'Pleas provide number of rows and/or columns to freeze' ).
    ENDIF.

    IF ip_num_columns IS SUPPLIED AND ip_num_columns <= 0.
      zcx_xslx2=>raise_text( 'Number of columns to freeze should be positive' ).
    ENDIF.

    IF ip_num_rows IS SUPPLIED AND ip_num_rows <= 0.
      zcx_xslx2=>raise_text( 'Number of rows to freeze should be positive' ).
    ENDIF.
  ...
  METHOD generate_title.
    DATA: lo_worksheets_iterator TYPE REF TO zcl_xslx2_collection_iterator,
          lo_worksheet           TYPE REF TO zcl_xslx2_worksheet.

    DATA: t_titles    TYPE HASHED TABLE OF zxslx2_sheet_title WITH UNIQUE KEY table_line,
          title       TYPE zxslx2_sheet_title,
          sheetnumber TYPE i.
...
* Now build sheetnumber.  Increase counter until we hit a number that is not used so far
  ...
  METHOD get_active_cell.
    ...
    DATA: lv_active_column TYPE zxslx2_cell_column_alpha,
          lv_active_row    TYPE string.

    lv_active_column = zcl_xslx2_common=>convert_column2alpha( active_cell-cell_column ).
  ...
  METHOD get_cell.
    ...
    DATA: lv_column        TYPE zxslx2_cell_column,
          lv_row           TYPE zxslx2_cell_row,
          ls_sheet_content TYPE zxslx2_s_cell_data.
    ...
    DATA: style_iterator TYPE REF TO zcl_xslx2_collection_iterator,
          style          TYPE REF TO zcl_xslx2_style.
  ...
  METHOD get_column.
    ...
    lv_column = zcl_xslx2_common=>convert_column2int( ip_column ).
  ...
  METHOD get_columns.
    ...
    DATA: columns TYPE TABLE OF i,
          column  TYPE i.
    FIELD-SYMBOLS:
          <sheet_cell> TYPE zxslx2_s_cell_data.
...
* By default, get_comments copies the collection (backward compatibility)
  ...
  METHOD get_default_excel_date_format.
    ...
    IF default_excel_date_format IS INITIAL.
      default_excel_date_format = zcl_xslx2_style_number_format=>c_format_date_ddmmyyyydot.
    ENDIF.
...
*0  24 Hour Format (Example: 12:05:10)
        default_excel_time_format = zcl_xslx2_style_number_format=>c_format_date_time6.
      WHEN 1.
*1  12 Hour Format (Example: 12:05:10 PM)
        default_excel_time_format = zcl_xslx2_style_number_format=>c_format_date_time2.
      WHEN 2.
...
*4  Hours from 0 to 11 (Example: 00:05:10 pm)  for now all the same. no chnage upper lower
  ...
  METHOD get_drawings.
    ...
    DATA: lo_drawing  TYPE REF TO zcl_xslx2_drawing,
          lo_iterator TYPE REF TO zcl_xslx2_collection_iterator.
  ...
  METHOD get_header_footer_drawings.
    DATA: ls_odd_header  TYPE zxslx2_s_worksheet_head_foot,
          ls_odd_footer  TYPE zxslx2_s_worksheet_head_foot,
          ls_even_header TYPE zxslx2_s_worksheet_head_foot,
          ls_even_footer TYPE zxslx2_s_worksheet_head_foot,
          ls_hd_ft       TYPE zxslx2_s_worksheet_head_foot.

    FIELD-SYMBOLS: <fs_drawings> TYPE zxslx2_s_drawings.
...
*** Even footer
  ...
  METHOD get_merge.
    ...
    LOOP AT me->mt_merged_cells ASSIGNING <ls_merged_cell>.
      ...
      lv_col_from = zcl_xslx2_common=>convert_column2alpha( <ls_merged_cell>-col_from ).
      lv_col_to   = zcl_xslx2_common=>convert_column2alpha( <ls_merged_cell>-col_to   ).
  ...
  METHOD get_rows.
    ...
    DATA: row TYPE i.
    FIELD-SYMBOLS: <sheet_cell> TYPE zxslx2_s_cell_data.
  ...
  METHOD get_style_cond.
    ...
    DATA: lo_style_iterator TYPE REF TO zcl_xslx2_collection_iterator,
          lo_style_cond     TYPE REF TO zcl_xslx2_style_cond.
...
*--------------------------------------------------------------------*
    ...
    DATA lv_errormessage TYPE string.
    DATA lv_max_col TYPE zxslx2_cell_column.
    DATA lv_max_row TYPE int4.
    DATA lv_delta_col TYPE int4.
    DATA lv_value  TYPE zxslx2_cell_value.
...
*--------------------------------------------------------------------*
              ...
              WHILE lv_actual_col <= lv_max_col.
                ...
                TRY.
                    ...
                    IF lv_type = 'D'.
                      <lv_value> = zcl_xslx2_common=>excel_string_to_date( ip_value = lv_value ).
                    ELSE.
...
*  CATCH zcx_excel.    "
  ...
  METHOD get_title.
    ...
    IF ip_escaped EQ abap_true.
      lv_value = me->title.
      ep_title = zcl_xslx2_common=>escape_string( lv_value ).
    ELSE.
      ep_title = me->title.
    ENDIF.
  ENDMETHOD.                    "GET_TITLE
...
* We need to convert with output conversion function
  ...
  METHOD move_supplied_borders.
    ...
    DATA: ls_borderx TYPE zxslx2_s_cstylex_border.
  ...
  METHOD normalize_column_heading_texts.
    ...
    DATA: lt_field_catalog      TYPE zxslx2_t_fieldcatalog,
          lv_value_lowercase    TYPE string,
          lv_scrtext_l_initial  TYPE zxslx2_column_name,
    ...
    FIELD-SYMBOLS: <ls_field_catalog> TYPE zxslx2_s_fieldcatalog,
                   <scrtxt1>          TYPE any,
                   <scrtxt2>          TYPE any,
                   <scrtxt3>          TYPE any.
  ...
  METHOD normalize_columnrow_parameter.
    ...
    IF ip_columnrow IS NOT INITIAL.
      zcl_xslx2_common=>convert_columnrow2column_a_row(
        EXPORTING
        ...
        IMPORTING
          ...
          e_row        = ep_row ).
    ELSE.
      ep_column = zcl_xslx2_common=>convert_column2int( ip_column ).
      ep_row    = ip_row.
    ENDIF.
  ...
  METHOD normalize_range_parameter.
    ...
    IF ip_range IS NOT INITIAL.
      zcl_xslx2_common=>convert_range2column_a_row(
        EXPORTING
          i_range            = ip_range
        IMPORTING
    ...
    ELSE.
      IF ip_column_start IS INITIAL.
        ep_column_start = zcl_xslx2_common=>c_excel_sheet_min_col.
      ELSE.
        ep_column_start = zcl_xslx2_common=>convert_column2int( ip_column_start ).
      ENDIF.
      IF ip_column_end IS INITIAL.
        ep_column_end = ep_column_start.
      ELSE.
        ep_column_end = zcl_xslx2_common=>convert_column2int( ip_column_end ).
      ENDIF.
      ep_row = ip_row.
      IF ep_row IS INITIAL.
        ep_row = zcl_xslx2_common=>c_excel_sheet_min_row.
      ENDIF.
      ep_row_to = ip_row_to.
  ...
  METHOD normalize_style_parameter.
    ...
    FIELD-SYMBOLS <style> TYPE REF TO zcl_xslx2_style.
    ...
    ELSE.
      RAISE EXCEPTION TYPE zcx_xslx2 EXPORTING error = 'IP_GUID type must be either REF TO zcl_excel_style or zexcel_cell_style'.
    ENDIF.
...
*--------------------------------------------------------------------*
    ...
    DATA: lo_range_iterator         TYPE REF TO zcl_xslx2_collection_iterator,
          lo_range                  TYPE REF TO zcl_xslx2_range,
...
*--------------------------------------------------------------------*
    ...
    WHILE lo_range_iterator->has_next( ) = abap_true.
      ...
      IF lo_range->name = zif_xslx2_sheet_printsettings=>gcv_print_title_name.
        EXIT.  " Found it
      ENDIF.
      CLEAR lo_range.
...
*--------------------------------------------------------------------*
      IF lo_range IS NOT BOUND.
        ...
        lo_range->name = zif_xslx2_sheet_printsettings=>gcv_print_title_name.
      ENDIF.

      lv_repeat_range_sheetname = me->get_title( ).
      lv_repeat_range_sheetname = zcl_xslx2_common=>escape_string( lv_repeat_range_sheetname ).
...
*--------------------------------------------------------------------*
  ...
  METHOD set_area.
    ...
    DATA: lv_row              TYPE zxslx2_cell_row,
          lv_row_start        TYPE zxslx2_cell_row,
          lv_row_end          TYPE zxslx2_cell_row,
          lv_column_int       TYPE zxslx2_cell_column,
          lv_column           TYPE zxslx2_cell_column_alpha,
          lv_column_start_int TYPE zxslx2_cell_column,
          lv_column_end_int   TYPE zxslx2_cell_column.
    ...
    ELSE.
      ...
      WHILE lv_column_int <= lv_column_end_int.
        ...
        lv_column = zcl_xslx2_common=>convert_column2alpha( lv_column_int ).
        lv_row = lv_row_start.
  ...
  METHOD set_area_formula.
    DATA: ld_row              TYPE zxslx2_cell_row,
          ld_row_start        TYPE zxslx2_cell_row,
          ld_row_end          TYPE zxslx2_cell_row,
          ld_column           TYPE zxslx2_cell_column_alpha,
          ld_column_int       TYPE zxslx2_cell_column,
          ld_column_start_int TYPE zxslx2_cell_column,
          ld_column_end_int   TYPE zxslx2_cell_column.
    ...
    ELSE.
      ...
      WHILE ld_column_int <= ld_column_end_int.
        ...
        ld_column = zcl_xslx2_common=>convert_column2alpha( ld_column_int ).
        ld_row = ld_row_start.
  ...
  METHOD set_area_hyperlink.
    DATA: ld_row_start        TYPE zxslx2_cell_row,
          ld_row_end          TYPE zxslx2_cell_row,
          ld_column_int       TYPE zxslx2_cell_column,
          ld_column_start_int TYPE zxslx2_cell_column,
          ld_column_end_int   TYPE zxslx2_cell_column,
          ld_current_column   TYPE zxslx2_cell_column_alpha,
          ld_current_row      TYPE zxslx2_cell_row,
          ld_value            TYPE string,
          ld_formula          TYPE string.
    DATA: lo_hyperlink TYPE REF TO zcl_xslx2_hyperlink.
    ...
    ld_column_int = ld_column_start_int.
    WHILE ld_column_int <= ld_column_end_int.
      ld_current_column = zcl_xslx2_common=>convert_column2alpha( ld_column_int ).
      ...
      WHILE ld_current_row <= ld_row_end.
        ...
        IF ip_is_internal = abap_true.
          lo_hyperlink = zcl_xslx2_hyperlink=>create_internal_link( iv_location = ip_url ).
        ELSE.
          lo_hyperlink = zcl_xslx2_hyperlink=>create_external_link( iv_url = ip_url ).
        ENDIF.
  ...
  METHOD set_cell.
    ...
    DATA: lv_column        TYPE zxslx2_cell_column,
          ls_sheet_content TYPE zxslx2_s_cell_data,
          lv_row           TYPE zxslx2_cell_row,
          lv_value         TYPE zxslx2_cell_value,
          lv_data_type     TYPE zxslx2_cell_data_type,
          lv_value_type    TYPE abap_typekind,
          lv_style_guid    TYPE zxslx2_cell_style,
          lo_addit         TYPE REF TO cl_abap_elemdescr,
          lt_rtf           TYPE zxslx2_t_rtf,
          lo_value         TYPE REF TO data,
          lo_value_new     TYPE REF TO data.

    FIELD-SYMBOLS: <fs_sheet_content> TYPE zxslx2_s_cell_data,
      ...
      ELSE.
        ...
        CASE lv_value_type.
          WHEN cl_abap_typedescr=>typekind_int OR cl_abap_typedescr=>typekind_int1 OR cl_abap_typedescr=>typekind_int2
            ...
            IF sy-subrc = 0.
              <fs_numeric> = <fs_value>.
              lv_value = zcl_xslx2_common=>number_to_excel_string( ip_value = <fs_numeric> ).
            ENDIF.
          ...
          WHEN cl_abap_typedescr=>typekind_float OR cl_abap_typedescr=>typekind_packed OR
            ...
            IF lv_value_type = cl_abap_typedescr=>typekind_packed
              ...
              lv_value = zcl_xslx2_common=>number_to_excel_string( ip_value    = <fs_value>
          ...
          WHEN cl_abap_typedescr=>typekind_date.
            ...
            IF sy-subrc = 0.
              <fs_date> = <fs_value>.
              lv_value = zcl_xslx2_common=>date_to_excel_string( ip_value = <fs_date> ) .
            ENDIF.
* Begin of change issue #152 - don't touch exisiting style if only value is passed
...
* End of change issue #152 - don't touch exisiting style if only value is passed
          ...
          WHEN cl_abap_typedescr=>typekind_time.
            ...
            IF sy-subrc = 0.
              <fs_time> = <fs_value>.
              lv_value = zcl_xslx2_common=>time_to_excel_string( ip_value = <fs_time> ).
            ENDIF.
* Begin of change issue #152 - don't touch exisiting style if only value is passed
...
* End of change issue #152 - don't touch exisiting style if only value is passed
          ...
          WHEN typekind_utclong.
            ...
            IF sy-subrc = 0.
              <lv_utclong> = <fs_value>.
              lv_value = zcl_xslx2_common=>utclong_to_excel_string( <lv_utclong> ).
            ENDIF.

          WHEN OTHERS.
            zcx_xslx2=>raise_text( 'Invalid data type of input value' ).
        ENDCASE.
      ENDIF.
      ...
      IF <fs_sheet_content> IS ASSIGNED AND <fs_sheet_content>-table_header IS NOT INITIAL AND lv_value IS NOT INITIAL.
        ...
        IF sy-subrc = 0.
          ...
          IF <ls_fieldcat>-column_name <> lv_value.
            zcx_xslx2=>raise_text( 'Cell is table column header - this value is not allowed' ).
          ENDIF.
        ENDIF.
      ENDIF.
...
* End of change issue #152 - don't touch exisiting style if only value is passed
    ...
    ELSE.
      ...
      ls_sheet_content-cell_coords  = zcl_xslx2_common=>convert_column_a_row2columnrow( i_column = lv_column i_row = lv_row ).
...
*                      If not, use default
    DATA: lo_format_code_datetime TYPE zxslx2_number_format.
    DATA: stylemapping    TYPE zxslx2_s_stylemapping.
    ...
    CASE lv_value_type.
      WHEN cl_abap_typedescr=>typekind_date.
        ...
        IF stylemapping-complete_stylex-number_format-format_code IS INITIAL OR
          ...
          lo_format_code_datetime = zcl_xslx2_style_number_format=>c_format_date_std.
        ELSE.
      ...
      WHEN cl_abap_typedescr=>typekind_time.
        ...
        IF stylemapping-complete_stylex-number_format-format_code IS INITIAL OR
           stylemapping-complete_style-number_format-format_code IS INITIAL.
          lo_format_code_datetime = zcl_xslx2_style_number_format=>c_format_date_time6.
        ELSE.
          lo_format_code_datetime = stylemapping-complete_style-number_format-format_code.
        ENDIF.
        me->change_cell_style( ip_column                      = lv_column
      ...
      WHEN typekind_utclong.
        ...
        IF stylemapping-complete_stylex-number_format-format_code IS INITIAL OR
           stylemapping-complete_style-number_format-format_code IS INITIAL.
          lo_format_code_datetime = zcl_xslx2_style_number_format=>c_format_date_datetime.
        ELSE.
          lo_format_code_datetime = stylemapping-complete_style-number_format-format_code.
        ENDIF.
        me->change_cell_style( ip_column                      = lv_column
...
* End of Fix issue #162
  ...
  METHOD set_cell_formula.
    DATA:
      lv_column        TYPE zxslx2_cell_column,
      lv_row           TYPE zxslx2_cell_row,
...
*--------------------------------------------------------------------*
  ...
  METHOD set_table_reference.
    ...
    FIELD-SYMBOLS: <ls_sheet_content> TYPE zxslx2_s_cell_data.
    ...
    ELSE.
      zcx_xslx2=>raise_text( 'Cell not found' ).
    ENDIF.
  ...
  METHOD set_column_width.
    DATA: lo_column  TYPE REF TO zcl_xslx2_column.
    DATA: width             TYPE f.
...
* if a fix size is supplied use this
    IF ip_width_fix IS SUPPLIED.
      TRY.
          width = ip_width_fix.
          IF width <= 0.
            zcx_xslx2=>raise_text( 'Please supply a positive number as column-width' ).
          ENDIF.
          lo_column->set_width( width ).
          RETURN.
        CATCH cx_sy_conversion_no_number.
* Strange stuff passed --> raise error
          zcx_xslx2=>raise_text( 'Unable to interpret supplied input as number' ).
      ENDTRY.
    ENDIF.
...
* If we get down to here, we have to use whatever is found in autosize.
  ...
  METHOD set_default_excel_date_format.
    ...
    IF ip_default_excel_date_format IS INITIAL.
      zcx_xslx2=>raise_text( 'Default date format cannot be blank' ).
    ENDIF.
  ...
  METHOD set_merge.
    ...
    DATA: ls_merge        TYPE mty_merge,
          lv_column_start TYPE zxslx2_cell_column,
          lv_column_end   TYPE zxslx2_cell_column,
          lv_row          TYPE zxslx2_cell_row,
          lv_row_to       TYPE zxslx2_cell_row,
...
*--------------------------------------------------------------------*
  ...
  METHOD set_merge_style.
    DATA: ld_row_start      TYPE zxslx2_cell_row,
          ld_row_end        TYPE zxslx2_cell_row,
          ld_column_int     TYPE zxslx2_cell_column,
          ld_column_start   TYPE zxslx2_cell_column,
          ld_column_end     TYPE zxslx2_cell_column,
          ld_current_column TYPE zxslx2_cell_column_alpha,
          ld_current_row    TYPE zxslx2_cell_row.
  ...
  METHOD set_pane_top_left_cell.
    DATA lv_column_int TYPE zxslx2_cell_column.
    DATA lv_row TYPE zxslx2_cell_row.
    ...
    zcl_xslx2_common=>convert_columnrow2column_a_row(
      ...
      IMPORTING
        ...
        e_row        = lv_row ).
    IF lv_column_int NOT BETWEEN zcl_xslx2_common=>c_excel_sheet_min_col AND zcl_xslx2_common=>c_excel_sheet_max_col
        OR lv_row NOT BETWEEN zcl_xslx2_common=>c_excel_sheet_min_row AND zcl_xslx2_common=>c_excel_sheet_max_row.
      RAISE EXCEPTION TYPE zcx_xslx2 EXPORTING error = 'Invalid column/row coordinates (valid values: A1 to XFD1048576)'.
    ENDIF.
  ...
  METHOD set_row_height.
    DATA: lo_row  TYPE REF TO zcl_xslx2_row.
    DATA: height  TYPE f.
...
* Strange stuff passed --> raise error
  ...
  METHOD set_row_outline.
    ...
    IF sy-subrc <> 0.
      IF iv_row_from <= 0.
        zcx_xslx2=>raise_text( 'First row of outline must be a positive number' ).
      ENDIF.
      IF iv_row_to < iv_row_from.
        zcx_xslx2=>raise_text( 'Last row of outline may not be less than first line of outline' ).
      ENDIF.
    ...
    CASE iv_collapsed.
      ...
      WHEN OTHERS.
        zcx_xslx2=>raise_text( 'Unknown collapse state' ).
  ...
  METHOD set_table.
    ...
    DATA: lo_structdescr  TYPE REF TO cl_abap_structdescr,
          ...
          lv_column_int   TYPE zxslx2_cell_column,
          lv_column_alpha TYPE zxslx2_cell_column_alpha,
          lv_cell_value   TYPE zxslx2_cell_value.
    ...
    lv_column_int = zcl_xslx2_common=>convert_column2int( ip_top_left_column ).
    ...
    lt_dfies = zcl_xslx2_common=>describe_structure( io_struct = lo_structdescr ).
...
* It is better to loop column by column
  ...
  METHOD set_title.
    DATA: lo_worksheets_iterator TYPE REF TO zcl_xslx2_collection_iterator,
          ...
          lo_ranges_iterator     TYPE REF TO zcl_xslx2_collection_iterator,
          lo_range               TYPE REF TO zcl_xslx2_range,
          lv_range_value         TYPE zxslx2_range_value,
...
*--------------------------------------------------------------------*
    lv_rangesheetname_old = zcl_xslx2_common=>escape_string( me->title ) && '!'.
    me->title = ip_title.
...
*--------------------------------------------------------------------*
    lv_rangesheetname_new = zcl_xslx2_common=>escape_string( me->title ) && '!'.
  ...
  METHOD update_dimension_range.
    ...
    DATA: ls_sheet_content TYPE zxslx2_s_cell_data,
    ...
    IF upper_cell-cell_row = 0.
      upper_cell-cell_row = zcl_xslx2_common=>c_excel_sheet_max_row.
    ENDIF.
    upper_cell-cell_column = zcl_xslx2_common=>c_excel_sheet_max_col.

    lower_cell-cell_row = rows->get_max_index( ).
    IF lower_cell-cell_row = 0.
      lower_cell-cell_row = zcl_xslx2_common=>c_excel_sheet_min_row.
    ENDIF.
    lower_cell-cell_column = zcl_xslx2_common=>c_excel_sheet_min_col.
    ...
    upper_cell-cell_coords = zcl_xslx2_common=>convert_column_a_row2columnrow( i_column = upper_cell-cell_column i_row = upper_cell-cell_row ).

    lower_cell-cell_coords = zcl_xslx2_common=>convert_column_a_row2columnrow( i_column = lower_cell-cell_column i_row = lower_cell-cell_row ).

  ENDMETHOD.                    "UPDATE_DIMENSION_RANGE


  METHOD zif_xslx2_sheet_printsettings~clear_print_repeat_columns.
...
*--------------------------------------------------------------------*
  ...
  METHOD zif_xslx2_sheet_printsettings~clear_print_repeat_rows.
...
*--------------------------------------------------------------------*
  ...
  METHOD zif_xslx2_sheet_printsettings~get_print_repeat_columns.
  ...
  METHOD zif_xslx2_sheet_printsettings~get_print_repeat_rows.
  ...
  METHOD zif_xslx2_sheet_printsettings~set_print_repeat_columns.
*--------------------------------------------------------------------*
* issue#235 - repeat rows/columns
...
*--------------------------------------------------------------------*
    ...
    lv_col_from_int = zcl_xslx2_common=>convert_column2int( iv_columns_from ).
    lv_col_to_int   = zcl_xslx2_common=>convert_column2int( iv_columns_to ).
...
*--------------------------------------------------------------------*
  ...
  METHOD zif_xslx2_sheet_printsettings~set_print_repeat_rows.
*--------------------------------------------------------------------*
* issue#235 - repeat rows/columns
*           - Stefan Schmöcker,                             2012-12-02
*--------------------------------------------------------------------*
...
*--------------------------------------------------------------------*
  ...
  METHOD zif_xslx2_sheet_properties~get_right_to_left.
    result = right_to_left.
  ENDMETHOD.


  METHOD zif_xslx2_sheet_properties~get_style.
    IF zif_xslx2_sheet_properties~style IS NOT INITIAL.
      ep_style = zif_xslx2_sheet_properties~style.
    ELSE.
  ...
  METHOD zif_xslx2_sheet_properties~initialize.

    zif_xslx2_sheet_properties~show_zeros   = zif_xslx2_sheet_properties=>c_showzero.
    zif_xslx2_sheet_properties~summarybelow = zif_xslx2_sheet_properties=>c_below_on.
    zif_xslx2_sheet_properties~summaryright = zif_xslx2_sheet_properties=>c_right_on.

* inizialize zoomscale values
    zif_xslx2_sheet_properties~zoomscale = 100.
    zif_xslx2_sheet_properties~zoomscale_normal = 100.
    zif_xslx2_sheet_properties~zoomscale_pagelayoutview = 100 .
    zif_xslx2_sheet_properties~zoomscale_sheetlayoutview = 100 .
  ENDMETHOD.                    "ZIF_EXCEL_SHEET_PROPERTIES~INITIALIZE


  METHOD zif_xslx2_sheet_properties~set_right_to_left.
    me->right_to_left = right_to_left.
  ENDMETHOD.


  METHOD zif_xslx2_sheet_properties~set_style.
    zif_xslx2_sheet_properties~style = ip_style.
  ENDMETHOD.                    "ZIF_EXCEL_SHEET_PROPERTIES~SET_STYLE


  METHOD zif_xslx2_sheet_protection~initialize.

    me->zif_xslx2_sheet_protection~protected = zif_xslx2_sheet_protection=>c_unprotected.
    CLEAR me->zif_xslx2_sheet_protection~password.
    me->zif_xslx2_sheet_protection~auto_filter            = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~delete_columns         = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~delete_rows            = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~format_cells           = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~format_columns         = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~format_rows            = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~insert_columns         = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~insert_hyperlinks      = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~insert_rows            = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~objects                = zif_xslx2_sheet_protection=>c_noactive.
*  me->zif_excel_sheet_protection~password               = zif_excel_sheet_protection=>c_noactive. "issue #68
    me->zif_xslx2_sheet_protection~pivot_tables           = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~protected              = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~scenarios              = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~select_locked_cells    = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~select_unlocked_cells  = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~sheet                  = zif_xslx2_sheet_protection=>c_noactive.
    me->zif_xslx2_sheet_protection~sort                   = zif_xslx2_sheet_protection=>c_noactive.

  ENDMETHOD.                    "ZIF_EXCEL_SHEET_PROTECTION~INITIALIZE


  METHOD zif_xslx2_sheet_vba_project~set_codename.
    me->zif_xslx2_sheet_vba_project~codename = ip_codename.
  ENDMETHOD.                    "ZIF_EXCEL_SHEET_VBA_PROJECT~SET_CODENAME


  METHOD zif_xslx2_sheet_vba_project~set_codename_pr.
    me->zif_xslx2_sheet_vba_project~codename_pr = ip_codename_pr.
