...
CLASS zcl_xslx2_worksheet DEFINITION LOCAL FRIENDS
...
* ================
    DATA:
      f_cut TYPE REF TO zcl_xslx2_worksheet.  "class under test
...
CLASS ltc_calculate_table_bottom_rig DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA:
      ...
      field_catalog      TYPE zxslx2_t_fieldcatalog,
      field_catalog_line TYPE zxslx2_s_fieldcatalog,
      table_settings     TYPE zxslx2_s_table_settings.  "class under test
...
CLASS ltc_check_cell_column_formula DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    METHODS: should_fail
      IMPORTING
        ip_formula_id TYPE zxslx2_s_cell_data-column_formula_id
        ip_formula    TYPE zxslx2_s_cell_data-cell_formula OPTIONAL
        ip_value      TYPE zxslx2_s_cell_data-cell_value OPTIONAL
        ip_row        TYPE zxslx2_s_cell_data-cell_row
        ip_column     TYPE zxslx2_s_cell_data-cell_column
        ip_exp        TYPE string
      RAISING
        zcx_xslx2.

    DATA: mt_column_formulas TYPE zcl_xslx2_worksheet=>mty_th_column_formula,
          c_messages         LIKE zcl_xslx2_worksheet=>c_messages.
...
CLASS ltc_check_overlapping DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    TYPES : BEGIN OF ty_parameters,
              BEGIN OF input,
                table_settings       TYPE zxslx2_s_table_settings,
                other_table_settings TYPE zcl_xslx2_worksheet=>ty_table_settings,
              END OF input,
              BEGIN OF output,
                fails TYPE abap_bool,
              END OF output,
            END OF ty_parameters.
    DATA: table_1_settings TYPE zxslx2_s_table_settings.
...
CLASS ltc_check_rtf DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA cut                    TYPE REF TO zcl_xslx2_worksheet. " class under test
    DATA t_rtf                  TYPE zxslx2_t_rtf.
    DATA underline_double_style TYPE REF TO zcl_xslx2_style.
    DATA s_rtf                  TYPE zxslx2_s_rtf.
    DATA act_rtf_1              TYPE zxslx2_s_rtf.
    DATA act_rtf_2              TYPE zxslx2_s_rtf.
    DATA act_rtf_3              TYPE zxslx2_s_rtf.
    DATA exp_rtf_1              TYPE zxslx2_s_rtf.
    DATA exp_rtf_2              TYPE zxslx2_s_rtf.
    DATA exp_rtf_3              TYPE zxslx2_s_rtf.
    DATA style_arial_20         TYPE REF TO zcl_xslx2_style.
...
CLASS ltc_normalize_column_heading DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA:
      cut           TYPE REF TO zcl_xslx2_worksheet,  "class under test
    ...
    METHODS:
      ...
      assert
        IMPORTING
          ...
          ip_colname_exp TYPE zxslx2_column_name OPTIONAL,

      assert_multi
        IMPORTING
          it_fc          TYPE zxslx2_t_fieldcatalog OPTIONAL
  ...
  PRIVATE SECTION.
    TYPES : BEGIN OF ty_parameters,
              BEGIN OF input,
                ...
                row          TYPE zxslx2_cell_row,
                row_to       TYPE zxslx2_cell_row,
              END OF input,
              BEGIN OF output,
                fails        TYPE abap_bool,
                column_start TYPE zxslx2_cell_column,
                column_end   TYPE zxslx2_cell_column,
...
* =============
    ...
    DATA lo_excel TYPE REF TO zcl_xslx2.
...
CLASS ltc_calculate_table_bottom_rig IMPLEMENTATION.
  ...
  METHOD simple.
    ...
    zcl_xslx2_worksheet=>calculate_table_bottom_right(
      EXPORTING
        ip_table         = test_table
...
CLASS ltc_check_cell_column_formula IMPLEMENTATION.
  ...
  METHOD setup.
    ...
    DATA: ls_column_formula  TYPE zcl_xslx2_worksheet=>mty_s_column_formula.

    c_messages = zcl_xslx2_worksheet=>c_messages.
  ...
  METHOD success.
    ...
    zcl_xslx2_worksheet=>check_cell_column_formula(
  ...
  METHOD should_fail.
    ...
    DATA: lo_exception TYPE REF TO zcx_xslx2.
    ...
    TRY.
      ...
      CATCH zcx_xslx2 INTO lo_exception.
...
CLASS ltc_check_overlapping IMPLEMENTATION.
  ...
  METHOD assert.
    DATA: error TYPE REF TO zcx_xslx2.
    FIELD-SYMBOLS:
          <table> TYPE STANDARD TABLE.

    TRY.

        zcl_xslx2_worksheet=>check_table_overlapping(
...
CLASS ltc_check_rtf IMPLEMENTATION.
  ...
  METHOD setup.
    DATA style_guid TYPE zxslx2_cell_style.

    CREATE OBJECT excel.

    style_arial_20               = excel->add_new_style( ).
    style_arial_20->font->name   = zcl_xslx2_style_font=>c_name_arial.
    style_arial_20->font->scheme = zcl_xslx2_style_font=>c_scheme_none.
    ...
    underline_double_style->font->name           = zcl_xslx2_style_font=>c_name_roman.
    underline_double_style->font->scheme         = zcl_xslx2_style_font=>c_scheme_none.
    underline_double_style->font->family         = zcl_xslx2_style_font=>c_family_roman.
    underline_double_style->font->underline      = abap_true.
    underline_double_style->font->underline_mode = zcl_xslx2_style_font=>c_underline_double.
    underline_double_style->font->name           = zcl_xslx2_style_font=>c_name_roman.
    underline_double_style->font->scheme         = zcl_xslx2_style_font=>c_scheme_none.
    underline_double_style->font->family         = zcl_xslx2_style_font=>c_family_roman.
...
CLASS ltc_normalize_column_heading IMPLEMENTATION.
  ...
  METHOD default_text_if_none.
    ...
    CONSTANTS: lc_initial_line TYPE zxslx2_s_fieldcatalog VALUE IS INITIAL.
    DATA lt_fc TYPE zxslx2_t_fieldcatalog.
  ...
  METHOD assert.
    ...
    DATA:
      ls_fc TYPE zxslx2_s_fieldcatalog,
      lt_fc TYPE zxslx2_t_fieldcatalog.
