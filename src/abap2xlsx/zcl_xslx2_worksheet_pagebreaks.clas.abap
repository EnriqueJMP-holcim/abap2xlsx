CLASS zcl_xslx2_worksheet_pagebreaks DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ts_pagebreak_at ,
        ...
        cell_column TYPE zxslx2_cell_column,
...
CLASS zcl_xslx2_worksheet_pagebreaks IMPLEMENTATION.
  ...
  METHOD add_pagebreak.
    ...
    ls_pagebreak-cell_column = zcl_xslx2_common=>convert_column2int( ip_column ).
