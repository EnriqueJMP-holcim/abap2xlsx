...
CLASS zcl_xslx2_writer_2007 DEFINITION LOCAL FRIENDS lcl_create_xl_sheet.
CLASS lcl_create_xl_sheet DEFINITION CREATE PUBLIC .

  PUBLIC SECTION.
    METHODS create IMPORTING io_worksheet         TYPE REF TO zcl_xslx2_worksheet
                             iv_active            TYPE flag DEFAULT ''
                             io_document          TYPE REF TO if_ixml_document
                             io_excel_writer_2007 TYPE REF TO zcl_xslx2_writer_2007
                   RAISING   zcx_xslx2.
  PROTECTED SECTION.
  PRIVATE SECTION.
    TYPES: BEGIN OF colors,
             colorrgb TYPE zxslx2_color,
           END OF colors,
           BEGIN OF cfvo,
             value TYPE zxslx2_conditional_value,
             type  TYPE zxslx2_conditional_type,
           END OF cfvo,
    ...
    DATA:
      o_excel_ref    TYPE REF TO zcl_xslx2_writer_2007,
      o_worksheet    TYPE REF TO zcl_xslx2_worksheet,
    ...
    METHODS:
      add_sheetpr,
      add_dimension                   RAISING zcx_xslx2,
      add_sheet_views                 RAISING zcx_xslx2,
      add_sheetformatpr               RAISING zcx_xslx2,
      add_cols                        RAISING zcx_xslx2,
      add_sheet_protection,
      add_autofilter                  RAISING zcx_xslx2,
      add_merge_cells                 RAISING zcx_xslx2,
      add_conditional_formatting      RAISING zcx_xslx2,
      ...
      add_table_parts,
      add_sheet_data                  RAISING zcx_xslx2,
      add_page_breaks,
      add_ignored_errors.
ENDCLASS.
...
* Theme not supported yet - start with RGB
    ...
    lv_value = o_worksheet->zif_xslx2_sheet_properties~summarybelow.
    CONDENSE lv_value.
    lo_element_2->set_attribute_ns( name  = lc_xml_attr_summarybelow
                                    value = lv_value ).

    lv_value = o_worksheet->zif_xslx2_sheet_properties~summaryright.
    CONDENSE lv_value.
  ...
  METHOD add_sheet_views.
    ...
    DATA: lv_value                    TYPE string,
          lv_freeze_cell_row          TYPE zxslx2_cell_row,
          lv_freeze_cell_column       TYPE zxslx2_cell_column,
          lv_freeze_cell_column_alpha TYPE zxslx2_cell_column_alpha.
    ...
    lo_element_2 = o_document->create_simple_element( name   = lc_xml_node_sheetview
                                                      parent = o_document ).
    IF o_worksheet->zif_xslx2_sheet_properties~show_zeros EQ abap_false.
      lo_element_2->set_attribute_ns( name  = lc_xml_attr_showzeros
                                      value = '0' ).
    ENDIF.
    IF   v_active = abap_true
      OR o_worksheet->zif_xslx2_sheet_properties~selected EQ abap_true.
    ...
    ENDIF.
    " Zoom scale
    IF o_worksheet->zif_xslx2_sheet_properties~zoomscale NE 0.
      IF o_worksheet->zif_xslx2_sheet_properties~zoomscale GT 400.
        o_worksheet->zif_xslx2_sheet_properties~zoomscale = 400.
      ELSEIF o_worksheet->zif_xslx2_sheet_properties~zoomscale LT 10.
        o_worksheet->zif_xslx2_sheet_properties~zoomscale = 10.
      ENDIF.
      lv_value = o_worksheet->zif_xslx2_sheet_properties~zoomscale.
      CONDENSE lv_value.
      lo_element_2->set_attribute_ns( name  = lc_xml_attr_zoomscale
                                      value = lv_value ).
    ENDIF.
    IF o_worksheet->zif_xslx2_sheet_properties~zoomscale_normal NE 0.
      IF o_worksheet->zif_xslx2_sheet_properties~zoomscale_normal GT 400.
        o_worksheet->zif_xslx2_sheet_properties~zoomscale_normal = 400.
      ELSEIF o_worksheet->zif_xslx2_sheet_properties~zoomscale_normal LT 10.
        o_worksheet->zif_xslx2_sheet_properties~zoomscale_normal = 10.
      ENDIF.
      lv_value = o_worksheet->zif_xslx2_sheet_properties~zoomscale_normal.
      CONDENSE lv_value.
      lo_element_2->set_attribute_ns( name  = lc_xml_attr_zoomscalenormal
                                      value = lv_value ).
    ENDIF.
    IF o_worksheet->zif_xslx2_sheet_properties~zoomscale_pagelayoutview NE 0.
      IF o_worksheet->zif_xslx2_sheet_properties~zoomscale_pagelayoutview GT 400.
        o_worksheet->zif_xslx2_sheet_properties~zoomscale_pagelayoutview = 400.
      ELSEIF o_worksheet->zif_xslx2_sheet_properties~zoomscale_pagelayoutview LT 10.
        o_worksheet->zif_xslx2_sheet_properties~zoomscale_pagelayoutview = 10.
      ENDIF.
      lv_value = o_worksheet->zif_xslx2_sheet_properties~zoomscale_pagelayoutview.
      CONDENSE lv_value.
      lo_element_2->set_attribute_ns( name  = lc_xml_attr_zoomscalepageview
                                      value = lv_value ).
    ENDIF.
    IF o_worksheet->zif_xslx2_sheet_properties~zoomscale_sheetlayoutview NE 0.
      IF o_worksheet->zif_xslx2_sheet_properties~zoomscale_sheetlayoutview GT 400.
        o_worksheet->zif_xslx2_sheet_properties~zoomscale_sheetlayoutview = 400.
      ELSEIF o_worksheet->zif_xslx2_sheet_properties~zoomscale_sheetlayoutview LT 10.
        o_worksheet->zif_xslx2_sheet_properties~zoomscale_sheetlayoutview = 10.
      ENDIF.
      lv_value = o_worksheet->zif_xslx2_sheet_properties~zoomscale_sheetlayoutview.
      CONDENSE lv_value.
      lo_element_2->set_attribute_ns( name  = lc_xml_attr_zoomscalesheetview
                                      value = lv_value ).
    ENDIF.
    IF o_worksheet->zif_xslx2_sheet_properties~get_right_to_left( ) EQ abap_true.
    ...
    IF lv_freeze_cell_row IS NOT INITIAL AND lv_freeze_cell_column IS NOT INITIAL.
      ...
      ELSE.
        lv_value = zcl_xslx2_common=>convert_column_a_row2columnrow( i_column = lv_freeze_cell_column
  ...
  METHOD add_sheetformatpr.
    DATA: lo_element         TYPE REF TO if_ixml_element,
          lo_column_default  TYPE REF TO zcl_xslx2_column,
          lo_row_default     TYPE REF TO zcl_xslx2_row,lv_value           TYPE string,
          lo_column_iterator TYPE REF TO zcl_xslx2_collection_iterator,
...
* Reset column iterator
    lo_column_iterator = o_worksheet->get_columns_iterator( ).
    lo_column_default = o_worksheet->get_default_column( ).
    IF o_worksheet->zif_xslx2_sheet_properties~get_style( ) IS NOT INITIAL OR lo_column_iterator->has_next( ) = abap_true.
      " cols node
...
* Always pass through this coding
      IF o_worksheet->zif_xslx2_sheet_properties~get_style( ) IS NOT INITIAL.
        DATA: lts_sorted_columns TYPE SORTED TABLE OF zxslx2_cell_column WITH UNIQUE KEY table_line.
        TYPES: BEGIN OF ty_missing_columns,
                 first_column TYPE zxslx2_cell_column,
                 last_column  TYPE zxslx2_cell_column,
...
* First collect columns that were already handled before.  The rest has to be inserted now
        ...
        WHILE lo_column_iterator->has_next( ) = abap_true.
          lo_column ?= lo_column_iterator->get_next( ).
          lv_column = zcl_xslx2_common=>convert_column2int( lo_column->get_column_index( ) ).
...
* Now find all columns that were missing so far
        ...
        ENDLOOP.
        missing_column-last_column = zcl_xslx2_common=>c_excel_sheet_max_col.
        APPEND missing_column TO t_missing_columns.
...
*        lv_value = zcl_excel_common=>c_excel_sheet_max_col."del issue #157  -  set sheet style ( add missing columns
          ...
          lo_element_2->set_attribute_ns( name  = lc_xml_attr_width
                                          value = lc_xml_attr_defaultwidth ).
          lv_style_guid = o_worksheet->zif_xslx2_sheet_properties~get_style( ).
          READ TABLE o_excel_ref->styles_mapping INTO ls_style_mapping WITH KEY guid = lv_style_guid.
...
*--------------------------------------------------------------------*
      IF o_worksheet->zif_xslx2_sheet_properties~hide_columns_from IS NOT INITIAL.
        lo_element_2 = o_document->create_simple_element( name   = lc_xml_node_col
                                                          parent = o_document ).
        lv_value = zcl_xslx2_common=>convert_column2int( o_worksheet->zif_xslx2_sheet_properties~hide_columns_from ).
...
* Autofilter must be set AFTER sheet protection in XML
    IF o_worksheet->zif_xslx2_sheet_protection~protected EQ abap_true.
      " sheetProtection node
      lo_element = o_document->create_simple_element( name   = lc_xml_node_sheetprotection
                                                      parent = o_document ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~password.
      IF lv_value IS NOT INITIAL.
        lo_element->set_attribute_ns( name  = lc_xml_attr_password
                                      value = lv_value ).
      ENDIF.
      lv_value = o_worksheet->zif_xslx2_sheet_protection~auto_filter.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_autofilter
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~delete_columns.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_deletecolumns
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~delete_rows.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_deleterows
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~format_cells.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_formatcells
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~format_columns.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_formatcolumns
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~format_rows.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_formatrows
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~insert_columns.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_insertcolumns
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~insert_hyperlinks.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_inserthyperlinks
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~insert_rows.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_insertrows
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~objects.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_objects
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~pivot_tables.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_pivottables
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~scenarios.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_scenarios
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~select_locked_cells.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_selectlockedcells
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~select_unlocked_cells.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_selectunlockedcell
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~sheet.
      CONDENSE lv_value NO-GAPS.
      lo_element->set_attribute_ns( name  = lc_xml_attr_sheet
                                    value = lv_value ).
      lv_value = o_worksheet->zif_xslx2_sheet_protection~sort.
      CONDENSE lv_value NO-GAPS.
...
*> End of insertion Issue #572 - Protect sheet with filter caused Excel error
  ...
  METHOD add_autofilter.
    DATA:
      ...
      lv_value       TYPE string,
      lv_column      TYPE zxslx2_cell_column,
      lt_values      TYPE zxslx2_t_autofilter_values,
      ls_values      TYPE zxslx2_s_autofilter_values,
...
* Create node filtercolumn
  ...
  METHOD add_conditional_formatting.
    DATA: lo_element               TYPE REF TO if_ixml_element,
          ...
          lv_value                 TYPE string,
          ls_databar               TYPE zxslx2_conditional_databar,      " Databar by Albert Lladanosa
          ls_colorscale            TYPE zxslx2_conditional_colorscale,
          ls_iconset               TYPE zxslx2_conditional_iconset,
          ls_cellis                TYPE zxslx2_conditional_cellis,
          ls_textfunction          TYPE zcl_xslx2_style_cond=>ts_conditional_textfunction,
          lv_column_start          TYPE zxslx2_cell_column_alpha,
          lv_row_start             TYPE zxslx2_cell_row,
          lv_cell_coords           TYPE zxslx2_cell_coords,
          ls_expression            TYPE zxslx2_conditional_expression,
          ls_conditional_top10     TYPE zxslx2_conditional_top10,
          ls_conditional_above_avg TYPE zxslx2_conditional_above_avg,
    ...
    WHILE lo_iterator->has_next( ) EQ abap_true.
      ...
      lo_element_2 = o_document->create_simple_element( name   = lc_xml_node_cfrule
                                                        parent = o_document ).
      IF lo_style_cond->rule = zcl_xslx2_style_cond=>c_rule_textfunction.
        IF lo_style_cond->mode_textfunction-textfunction = zcl_xslx2_style_cond=>c_textfunction_notcontains.
      ...
      CASE lo_style_cond->rule.
        ...
        WHEN zcl_xslx2_style_cond=>c_rule_iconset.
          ...
          lo_element_3 = o_document->create_simple_element( name   = lc_xml_node_iconset
                                                            parent = o_document ).
          IF ls_iconset-iconset NE zcl_xslx2_style_cond=>c_iconset_3trafficlights.
          ...
          CASE ls_iconset-iconset.
            WHEN zcl_xslx2_style_cond=>c_iconset_3trafficlights2 OR
                 zcl_xslx2_style_cond=>c_iconset_3arrows OR
                 zcl_xslx2_style_cond=>c_iconset_3arrowsgray OR
                 zcl_xslx2_style_cond=>c_iconset_3flags OR
                 zcl_xslx2_style_cond=>c_iconset_3signs OR
                 zcl_xslx2_style_cond=>c_iconset_3symbols OR
                 zcl_xslx2_style_cond=>c_iconset_3symbols2 OR
                 zcl_xslx2_style_cond=>c_iconset_3trafficlights OR
                 zcl_xslx2_style_cond=>c_iconset_3trafficlights2.
              ...
              APPEND ls_cfvo TO lt_cfvo.
            WHEN zcl_xslx2_style_cond=>c_iconset_4arrows OR
                 zcl_xslx2_style_cond=>c_iconset_4arrowsgray OR
                 zcl_xslx2_style_cond=>c_iconset_4rating OR
                 zcl_xslx2_style_cond=>c_iconset_4redtoblack OR
                 zcl_xslx2_style_cond=>c_iconset_4trafficlights.
              ls_cfvo-value = ls_iconset-cfvo1_value.
              ls_cfvo-type = ls_iconset-cfvo1_type.
              APPEND ls_cfvo TO lt_cfvo.
              ls_cfvo-value = ls_iconset-cfvo2_value.
              ...
              APPEND ls_cfvo TO lt_cfvo.
            WHEN zcl_xslx2_style_cond=>c_iconset_5arrows OR
                 zcl_xslx2_style_cond=>c_iconset_5arrowsgray OR
                 zcl_xslx2_style_cond=>c_iconset_5quarters OR
                 zcl_xslx2_style_cond=>c_iconset_5rating.
              ls_cfvo-value = ls_iconset-cfvo1_value.
              ls_cfvo-type = ls_iconset-cfvo1_type.
              APPEND ls_cfvo TO lt_cfvo.
              ls_cfvo-value = ls_iconset-cfvo2_value.
...
*--------------------------------------------------------------------------------------*
        WHEN zcl_xslx2_style_cond=>c_rule_textfunction.
          ...
          CASE ls_textfunction-textfunction.
            WHEN zcl_xslx2_style_cond=>c_textfunction_beginswith.
...
* end of ins issue #366 - missing conditional rules: top10
  ...
  METHOD add_drawing_for_comments.
    DATA: lo_element              TYPE REF TO if_ixml_element,
          lv_value                TYPE string,
          lo_drawing_for_comments TYPE REF TO zcl_xslx2_comments.
