...
CLASS zcl_xslx2_writer_2007 DEFINITION LOCAL FRIENDS
    ltc_column_formula
...
CLASS ltc_column_formula DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    METHODS set_cell
      IMPORTING
        is_cell_data TYPE zxslx2_s_cell_data
      RAISING
        zcx_xslx2.
    METHODS get_xml
      RETURNING
    ...
    DATA lo_excel TYPE REF TO zcl_xslx2_writer_2007.
    DATA lo_ixml TYPE REF TO if_ixml.
    DATA lo_root TYPE REF TO if_ixml_element.
    DATA lt_column_formulas TYPE zcl_xslx2_worksheet=>mty_th_column_formula.
    DATA lt_column_formulas_used TYPE zcl_xslx2_writer_2007=>mty_column_formulas_used.
    DATA lv_si TYPE i.
...
CLASS ltc_column_formula IMPLEMENTATION.
  ...
  METHOD one_column_formula.
    ...
    DATA ls_cell_data TYPE zxslx2_s_cell_data.
