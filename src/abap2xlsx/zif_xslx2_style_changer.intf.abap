INTERFACE zif_xslx2_style_changer
  PUBLIC .

  METHODS apply
    IMPORTING
      ip_worksheet   TYPE REF TO zcl_xslx2_worksheet
  ...
  METHODS set_font_color
    IMPORTING
      value         TYPE zxslx2_s_style_color
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_font_color_rgb
    IMPORTING
      value         TYPE zxslx2_style_color_argb
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_font_color_indexed
    IMPORTING
      value         TYPE zxslx2_style_color_indexed
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_font_color_theme
    IMPORTING
      value         TYPE zxslx2_style_color_theme
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_font_color_tint
    IMPORTING
      value         TYPE zxslx2_style_color_tint
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_font_family
    IMPORTING
      value         TYPE zxslx2_style_font_family
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  ...
  METHODS set_font_name
    IMPORTING
      value         TYPE zxslx2_style_font_name
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_font_scheme
    IMPORTING
      value         TYPE zxslx2_style_font_scheme
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  ...
  METHODS set_font_underline_mode
    IMPORTING
      value         TYPE zxslx2_style_font_underline
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_fill_filltype
    IMPORTING
      value         TYPE zxslx2_fill_type
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_fill_rotation
    IMPORTING
      value         TYPE zxslx2_rotation
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  ...
  METHODS set_fill_gradtype_type
    IMPORTING
      value         TYPE zxslx2_s_gradient_type-type
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_fill_gradtype_degree
    IMPORTING
      value         TYPE zxslx2_s_gradient_type-degree
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_fill_gradtype_bottom
    IMPORTING
      value         TYPE zxslx2_s_gradient_type-bottom
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_fill_gradtype_left
    IMPORTING
      value         TYPE zxslx2_s_gradient_type-left
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_fill_gradtype_top
    IMPORTING
      value         TYPE zxslx2_s_gradient_type-top
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_fill_gradtype_right
    IMPORTING
      value         TYPE zxslx2_s_gradient_type-right
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_fill_gradtype_position1
    IMPORTING
      value         TYPE zxslx2_s_gradient_type-position1
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_fill_gradtype_position2
    IMPORTING
      value         TYPE zxslx2_s_gradient_type-position2
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_fill_gradtype_position3
    IMPORTING
      value         TYPE zxslx2_s_gradient_type-position3
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_borders_diagonal_mode
    IMPORTING
      value         TYPE zxslx2_diagonal
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_alignment_horizontal
    IMPORTING
      value         TYPE zxslx2_alignment
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  ...
  METHODS set_alignment_textrotation
    IMPORTING
      value         TYPE zxslx2_text_rotation
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  ...
  METHODS set_alignment_indent
    IMPORTING
      value         TYPE zxslx2_indent
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  METHODS set_protection_hidden
    IMPORTING
      value         TYPE zxslx2_cell_protection
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  ...
  METHODS set_borders_top_color_tint
    ...
    RETURNING
      VALUE(result) TYPE REF TO zif_xslx2_style_changer.
  DATA: complete_style  TYPE zxslx2_s_cstyle_complete READ-ONLY,
        complete_stylex TYPE zxslx2_s_cstylex_complete READ-ONLY.
ENDINTERFACE.
